...
4. with your clean dataset, use a hosted OSS AI service like Together or Anyscale to fine-tune Mixtral 8x7B. you can also try to fine-tune GPT-3.5-Turbo on OpenAI, but I've personally gotten better results from Mixtral ![🤷](https://abs-0.twimg.com/emoji/v2/svg/1f937.svg)
5. swap out GPT-4 with your fine-tuned model and enjoy your healthy margins ![😎](https://abs-0.twimg.com/emoji/v2/svg/1f60e.svg)
