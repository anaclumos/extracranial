      ...
      this.addCommand({
        ...
        callback: () => {
          this.settings.lightStyle =
            lightStyles[(lightStyles.indexOf(this.settings.lightStyle) + 1) % lightStyles.length]
          this.saveData(this.settings)
          this.updateLightStyle()
        },
      })
      ...
      this.addCommand({
        ...
        callback: () => {
          this.settings.tableWidth =
            tableWidthStyles[(tableWidthStyles.indexOf(this.settings.tableWidth) + 1) % tableWidthStyles.length]
          this.saveData(this.settings)
          this.refresh()
        },
      })
      this.addCommand({
        ...
        callback: () => {
          this.settings.imgWidth =
            imgWidthStyles[(imgWidthStyles.indexOf(this.settings.imgWidth) + 1) % imgWidthStyles.length]
          this.saveData(this.settings)
          this.refresh()
        },
      })
      this.addCommand({
        ...
        callback: () => {
          this.settings.iframeWidth =
            iframeWidthStyles[(iframeWidthStyles.indexOf(this.settings.iframeWidth) + 1) % iframeWidthStyles.length]
          this.saveData(this.settings)
          this.refresh()
        },
      })
      this.addCommand({
        ...
        callback: () => {
          this.settings.chartWidth =
            chartWidthStyles[(chartWidthStyles.indexOf(this.settings.chartWidth) + 1) % chartWidthStyles.length]
          this.saveData(this.settings)
          this.refresh()
        },
      })
      this.addCommand({
        ...
        callback: () => {
          this.settings.mapWidth =
            mapWidthStyles[(mapWidthStyles.indexOf(this.settings.mapWidth) + 1) % mapWidthStyles.length]
          this.saveData(this.settings)
          this.refresh()
        },
      })
...
var MinimalSettingTab = class extends import_obsidian.PluginSettingTab {
  ...
  display() {
    ...
    new import_obsidian.Setting(containerEl)
      ...
      .addToggle((toggle) =>
        toggle.setValue(this.plugin.settings.useSystemTheme).onChange((value) => {
    ...
    new import_obsidian.Setting(containerEl)
      ...
      .addToggle((toggle) =>
        toggle.setValue(this.plugin.settings.colorfulFrame).onChange((value) => {
    ...
    new import_obsidian.Setting(containerEl)
      ...
      .addToggle((toggle) =>
        toggle.setValue(this.plugin.settings.colorfulActiveStates).onChange((value) => {
    ...
    new import_obsidian.Setting(containerEl)
      ...
      .addToggle((toggle) =>
        toggle.setValue(this.plugin.settings.colorfulHeadings).onChange((value) => {
    ...
    new import_obsidian.Setting(containerEl)
      ...
      .addToggle((toggle) =>
        toggle.setValue(this.plugin.settings.minimalStatus).onChange((value) => {
    ...
    new import_obsidian.Setting(containerEl)
      ...
      .addToggle((toggle) =>
        toggle.setValue(this.plugin.settings.bordersToggle).onChange((value) => {
    ...
    new import_obsidian.Setting(containerEl)
      ...
      .addToggle((toggle) =>
        toggle.setValue(this.plugin.settings.underlineInternal).onChange((value) => {
    ...
    new import_obsidian.Setting(containerEl)
      ...
      .addToggle((toggle) =>
        toggle.setValue(this.plugin.settings.underlineExternal).onChange((value) => {
    ...
    new import_obsidian.Setting(containerEl)
      ...
      .addToggle((toggle) =>
        toggle.setValue(this.plugin.settings.fullWidthMedia).onChange((value) => {
