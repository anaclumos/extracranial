...
Lunit은 'Learning unit'의 약자로, AI 기반 토털 암 케어를 제공하는 의료 AI 소프트웨어 회사입니다.
우리의 AI 솔루션은 암을 발견하고 암 치료 결과를 예측하여 적시에 개별 맞춤형 암 치료를 달성하는 데 도움을 줍니다.

### 🗨 팀 소개

Lunit의 AutoML 팀은 AI 제품 개발 프로세스 자동화에 중점을 둡니다. 수동 작업을 간소화함으로써 우리 팀은 효율적이고 효과적인 제품 개발을 가능하게 하는 데 중추적인 역할을 합니다. 또한 우리 팀은 AutoML 알고리즘 향상에 전념하고 있습니다. AI를 통해 암을 정복하겠다는 우리의 사명에 동참하세요. 여러분의 기여는 암 환자를 위한 AI 제품 개발을 발전시킬 것입니다.

### 🗨 직무 소개

- 이 역할에서는 Lunit에서 대부분의 AI 모델을 훈련하는 데 중요한 역할을 하는 클라우드 기반 AutoML 플랫폼의 발전을 주도하게 됩니다.
- 데이터 수집, 모델 훈련, 모델 선택 등 다양한 단계를 포괄하는 자동화된 제품 개발 프레임워크 개발에 적극적으로 참여하게 됩니다.

### 🚩 역할 및 책임

- 효율적인 딥러닝 연구를 가능하게 하는 클라우드 기반 AutoML 플랫폼 개발
- 확장 가능한 모델 개발을 가능하게 하는 자동화된 제품 개발 프레임워크 개발
- 새로운 프레임워크와 기존 프레임워크 모두의 유지 관리성, 신뢰성 및 효율성 향상
- 기존 프레임워크를 리팩토링하거나 새로운 기술과 라이브러리를 채택하여 고품질 소프트웨어 제작
- AutoML 알고리즘을 구현하고 내부 제품의 성능 최적화에 적용

### 🚩 사용 도구

- 개발 관련: Django, Django REST Framework, React, Next.js, MySQL, PostgreSQL, Redis, Celery, Nginx
- ML 프레임워크: PyTorch, Optuna
- 인프라: Google Cloud Platform, Kubernetes, Git, Docker
- 일반: Slack, Confluence, Jira

## 요구사항

### 🎯 자격 요건

- IT 업계에서 최소 2년 이상의 전문 경력
- AI 업계에서 머신러닝 엔지니어링 또는 연구 엔지니어링 경험
- Python, 단위/통합 테스트, 문서화, Git, 협업 코드 개발 및 Docker에 대한 숙련도
- 컴퓨터 과학 또는 관련 분야의 학사(B.Sc.), 석사(M.Sc.) 또는 박사(Ph.D.) 학위
- 영어로 기술 보고서를 작성할 수 있는 능력과 함께 뛰어난 의사소통 능력
- 개별 프로젝트에 대한 책임감과 주인의식을 가지고 헌신하는 자세 입증

### 🏅 우대 경험

- Django REST Framework에 대한 친숙도
- React 경험
- 플랫폼 개발 및 운영 경험
- 클라우드 컴퓨팅 서비스에 대한 지식
...
- 서류 심사 → 기술 면접 → 과제 → 역량 기반 면접(프레젠테이션) → 문화 적합성 면접 → 온보딩
  - 모든 면접은 영어로 진행됩니다.
  - 최종 면접 후 필요한 경우 레퍼런스 체크를 진행할 수 있습니다.

### 🤝 근무 조건 및 환경

- 근무 형태: 정규직
- 근무 장소: 루닛 본사(서울특별시 강남구 강남대로 374, 5층)
- 급여: 협의 후 결정

### 🎸 기타

- 경력이나 학력을 허위로 기재하거나 지원서에 거짓 또는 사기성 정보를 제공할 경우 채용이 취소될 수 있습니다.
- 루닛은 관련 법규에 따라 취업 보호 대상자(국가유공자 및 장애인)에게 우선 처리를 제공하기 위해 노력하고 있습니다.

## 복리후생

### 🌻 복리후생 및 혜택

- 새 사무실은 강남역 3번 출구에서 도보 1분 거리에 있어 매우 편리합니다.
- 회사에서 근무할 때 점심과 저녁 식사비로 각각 최대 12,000원까지 지원됩니다.
- 입사 시 개인 작업공간을 꾸미기 위해 최대 300,000원이 지원됩니다.
- Mac과 4K 모니터 등 최신 컴퓨터 모델을 제공하며, 3년마다 교체합니다.
- 세미나 참석 및 도서 구매비가 지원됩니다.
- 사내 AI 및 의료 세미나가 정기적으로 개최됩니다.
- 한국어/영어가 모국어가 아닌 루니티언을 위해 한국어/영어 교육이 제공됩니다.
- 고품질 AI 학습 자료 및 딥러닝 DevOps 시스템에 접근할 수 있습니다.
- 연간 최대 120만 원 상당의 복지 포인트를 사용할 수 있습니다.
- 한국 명절 선물: 설날과 추석 선물/상품권 제공
- 연례 건강검진 및 근로자 상해보험이 제공됩니다.
- 직원 모임 참여에 대한 금전적 지원 (월 1회)
