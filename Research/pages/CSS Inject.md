...
* {
  --font-family-headline:
    'SF Pro', ui-sans-serif, -apple-system, BlinkMacSystemFont, 'Apple SD Gothic Neo', 'Pretendard',
  ...
  font-feature-settings:
    'rlig', 'calt', 'case', 'ccmp', 'dlig', 'salt', 'tnum', 'zero', 'ss01', 'ss02', 'ss03', 'ss05', 'ss06', 'ss08',
    'ss15';
