...
일반적으로 알려지지 않은 사항이지만, [[CJK|한중일]]의 [[한자|한문]]은 모두 조금씩 다르다.

![[EF6FE0.gif]]

허나 [[대한민국|한국]] [[한자|한문]]은 자주 사용되지 않는다는 이유로 [[일본]] [[한자|한문]]을 그대로 가져오는 경우가 빈번하다.
이를 [[대한민국|한국]] [[한자|한문]] → [[일본]] [[한자|한문]] → [[중국]] [[한자|한문]] 순으로 Fallback 처리하려 했다.
