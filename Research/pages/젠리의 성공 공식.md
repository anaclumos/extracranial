...
**기술력**. 위치 추적 앱은 정말 많지만, 배터리를 많이 먹거나 성능이 떨어진다 (실시간이 아니거나, 위치 동그라미가 넓거나). [[Zenly|젠리]]는 정확한 위치 추적 앱임에도 배터리를 놀랍게 적게 쓴다. 창업 전 3년 이상 자녀 안전 앱을 개발하며 효율 좋은 위치 추적을 연구했다. [[Zenly|젠리]] 초기에도 박사급 인재들을 채용하며 독자적인 기술력을 보유했다. 서버와 프론트엔드 기술도 시니어 엔지니어 위주로 소수 정예 기업을 구성했다.
