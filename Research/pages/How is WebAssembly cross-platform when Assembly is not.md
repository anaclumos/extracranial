...
- To run [[WebAssembly|WASM]], the [[Web Browser|browser]] must still compile the [[WebAssembly|WASM]] code into ASM code when executing; in that way, it is **much** slower than [[WebAssembly|WASM]].
