...
I grew up reading [The Encyclopedia of Absolute and Relative Knowledge](https://en.wikipedia.org/wiki/L%27Encyclop%C3%A9die_du_savoir_relatif_et_absolu) and envisioned a _single source of truth_ just like it that integrated my projects and research. In [As We May Think](./.././docs/pages/As%20We%20May%20Think.md), [Vannevar Bush](./.././docs/pages/Vannevar%20Bush.md), a legendary scientist, describes [Memex](./.././docs/pages/Memex.md) as
...
This idea would later be implemented as the **Internet**. However, I, Sunghyun Cho, felt that the Internet helps keep records of humanity but is insufficient for capturing the individual's brain. Therefore, this website, Project [Aldehyde](./.././docs/pages/Aldehyde.md), aims to create a superset of [Memex](./.././docs/pages/Memex.md).
...
Thus, the name [Extracranial](./.././docs/pages/Extracranial.md), -- **The Exosuit for [Superbrains](./.././docs/pages/Superbrain.md)**.
...
I finally use [Vercel](./.././docs/pages/Vercel.md) for deploying, [caching](./.././docs/pages/Caching.md), and distributing.
