...
- Current [PKM](../Interests/PKM.md) software tries to make Wikipedia-like graphs, where there the "term" plays the key role in graphing. I want to make Britannica style [PKM](../Interests/PKM.md), where there is an organized post that conveys the knowledge.
- Wystan Hugh Auden
