...
Confirmed that two [WorkerDOM](../Interests/WorkerDOM.md) threads and one main thread appears.
...
### [Brane](../Projects/Brane.md) [WorkerDOM](../Interests/WorkerDOM.md) Non-blocking Example

![](../Assets/Pasted%20image%2020220706013827.png)

- Implemented the Technical Proof of Concept and posted here: _PoC that two [WorkerDOM](../Interests/WorkerDOM.md) upgraded threads don't block each other_ - [Two Roots](https://brane.vercel.app/two-roots-with-infinite-loop/)
1.  Open Dev Console.
