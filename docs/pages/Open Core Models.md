...
- [mattermost/focalboard](https://github.com/mattermost/focalboard) Focalboard is an open source, self-hosted [alternative](./../.././docs/pages/Alternative.md) to Trello, Notion, and Asana.
