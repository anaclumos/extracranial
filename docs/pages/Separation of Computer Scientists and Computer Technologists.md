...
## But a self-taught can code a dang fantastic [React](./../.././docs/pages/React.md) shopping mall!

- A self-taught dev can use [React](./../.././docs/pages/React.md) to make a cool-looking Single-Page-App [JavaScript](./../.././docs/pages/JavaScript.md) [e-commerce](./../.././docs/pages/e-commerce.md) website...
- But we must think,

> What makes [React](./../.././docs/pages/React.md) so coolly?

- [React](./../.././docs/pages/React.md)'s `Diff`ing Algorithm
  - Reduces $O(n^3)$ diffing operation to $O(n)$ **iff**
    1. Two elements of different types will produce other trees.
    2. The developer can hint at what elements will remain stable across renders with an essential prop. (This is why [React](./../.././docs/pages/React.md) always warns us to include keys in our props).
...
> So, simply wrapping all developers as _Software Engineers_ is like categorizing all musicians as singers, including incredibly different types of musicians, from street-performing rappers to classical oboists, from [Korean](./../.././docs/pages/%EB%8C%80%ED%95%9C%EB%AF%BC%EA%B5%AD.md) idols to shamanist drummers.
