...
- With [ML](./../.././docs/pages/ML.md) advancements, screenshots are now a universal data format.
  - (decoder) relatively easy to extract...
    - meaning (image-to-text)
    - layout information (object recognition)
    - text ([OCR](./../.././docs/pages/OCR.md))
    - other [metadata](./../.././docs/pages/Metadata.md) (formatting, fonts, etc.)
...
- What's good:
  ...
  - Universally available, easily copyable
    ...
    - You can copy objects from photos in the latest [Apple](./../.././docs/pages/Apple.md) [iOS](./../.././docs/pages/iOS.md) 16 update.
- Permissionless.
...
- More complex [metadata](./../.././docs/pages/Metadata.md)
  - Look how effective image search is on mobile. Dogs, City, Oceans...
  - Some come from the actual image [metadata](./../.././docs/pages/Metadata.md), and others are inferred with [On-device](./../.././docs/pages/On-Device.md) models.
...
- The "killer app" for [PDF](./../.././docs/pages/PDF.md) was [tax](./../.././docs/pages/Tax.md) returns - the [IRS](./../.././docs/pages/IRS.md) adopted [PDF](./../.././docs/pages/PDF.md) in 1996 because of a rumored frustration with the [US](./../.././docs/pages/United%20States%20of%20America.md) Postal Service.
- Things that lack:
  ...
  - Slow page loads. Better [alternatives](./../.././docs/pages/Alternative.md). [EPUB](./../.././docs/pages/EPUB.md), [MOBI](./../.././docs/pages/MOBI.md) for texts. For generic use cases, [DjVu](./../.././docs/pages/DjVu.md).
