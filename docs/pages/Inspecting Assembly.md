...
- [Assembly](./../.././docs/pages/Assembly.md)

| Command                                         | Description                                                                                     |
| ----------------------------------------------- | ----------------------------------------------------------------------------------------------- |
| [gdb](./../.././docs/pages/GDB.md) `executable` | starts executable                                                                               |
| `layout asm`                                    | prints [Assembly](./../.././docs/pages/Assembly.md) codes                                       |
...
| `quit`                                          | quits [gdb](./../.././docs/pages/GDB.md)                                                        |
| `"%d %[^\n]"`                                   | integer + string                                                                                |
