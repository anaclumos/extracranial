...
The model they used for Basecamp was to build great software that scratched their own itch ([project](./../.././docs/pages/Project.md) management,) and charge a monthly recurring amount to give them access ([SaaS](./../.././docs/pages/Software%20as%20a%20Service.md)) assuming others had the same problem. Then, focus on organic growth via product improvement and public writing. Finally, spend less than they make!
...
We'd made it…or so I thought. We consistently spending 2-3x our monthly revenue and losing money. Not [venture capital](./../.././docs/pages/Venture%20Capital.md). Out of my personal bank account, hopes in making much more.

### Asana

**Then, Asana.**
With a team a quarter of the size, and a fraction of the money, we had built what I felt was a superior product.
Around this time, Dustin invited me for a coffee in [San Francisco](./../.././docs/pages/San%20Francisco.md).
...
**I laughed!**
I was on the [bootstrapping](./../.././docs/pages/Bootstrap.md) train. He was drinking Silicon Valley KoolAid.
**Nice try!**
...
1. If you are in a competitive [VC](./../.././docs/pages/Venture%20Capital.md)-funded space, it's foolish to compete without raising money. Don't bring a knife to a gun fight.
...
5. Running a [SaaS](./../.././docs/pages/Software%20as%20a%20Service.md) business without deeply understanding churn, LTV, CAC etc, is like flying a plane without instrumentation--really stupid and dangerous.
...
10. [Bootstrapping](./../.././docs/pages/Bootstrap.md) works best in uncompetitive spaces/niches or if you have an unfair advantage (a personal brand, unique customer acquisition channel, etc).
