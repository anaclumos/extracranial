...
Some tools must choose to be dumbed down. [PKM](./../.././docs/pages/PKM.md) tools are one example.

There is a repeated paradigm in the [Tools for Thought](./../.././docs/pages/Tools%20for%20Thought.md) [Software as a Service](./../.././docs/pages/Software%20as%20a%20Service.md) market.
