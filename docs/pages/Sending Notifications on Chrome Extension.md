...
[2020-05-29](./../.././docs/journals/2020-05-29.md)

The goal is to...

1. Send notifications on Installation and Updates of a given [Chrome](./../.././docs/pages/Chrome.md) [Extension](./../.././docs/pages/WebExtension.md) (with different content, of course)
...
- You can use `chrome.runtime.getManifest().version` it to get the version of the [extension](./../.././docs/pages/WebExtension.md).
...
## Additional [Readings](./../.././docs/pages/Readings.md)
