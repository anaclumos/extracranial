...
- **Example**. [Joe Rogan interviews Steve Jobs @ podcast. ai](https://podcast.ai/).
  This is a fictional interview by having [AI](./../.././docs/pages/AI.md) learn about thousands of Joe Rogan's podcasts and thousands of Steve Jobs' speeches.
...
- I bought a couple of [Chinese](./../.././docs/pages/%EC%A4%91%EA%B5%AD.md) microphones; I wear them and turn them on all day, recording everything I speak; at the end of the day, the files are processed with [OpenAi](./../.././docs/pages/OpenAI.md)'s Whisper and transformed into text files from which the information is extracted
...
> A BM model came to mind about [AI](./../.././docs/pages/AI.md) illustration production... How about making a data set from which you learned your painting style as a plug-in, just like creating speech synthesis data? Isn't it a win-win structure if the user receives a certain amount of revenue each time they use the registered learning data, or if the data itself is a subscription system? [TEXTHOLIC](https://twitter.com/TextholicJ/status/1580025435886301184)
...
> "보이스 메이커를 통해 제작된 [AI](./../.././docs/pages/AI.md) 보이스는 [네이버](./../.././docs/pages/Naver.md) 클로바더빙 서비스에서 누구나 무료로 이용할 수 있게 제공합니다. 향후에는 클로바더빙 유료 버전 등 클로바 보이스 연계 유료 상품에도 확대 제공하여 발생하는 수익을 배분하는 방식도 고려하고 있습니다." I think it was a lump sum payment. [TEXTHOLIC](https://twitter.com/TextholicJ/status/1580028575708639234)
