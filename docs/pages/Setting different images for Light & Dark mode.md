...
Using `preferred color scheme` [CSS](./../.././docs/pages/CSS.md) property and [HTML](./../.././docs/pages/HTML.md) Picture `srcset` property.
...
<a title="Simple Analytics" href="" referrerpolicy="origin" target="_blank">
  <picture>
    <source
      ...
      srcset="https://simpleanalyticsbadges.com/cho.sh?mode=dark"
    />
    <img
