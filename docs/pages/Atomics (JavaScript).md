...
- [SharedArrayBuffer](./../.././docs/pages/SharedArrayBuffer.md)를 이용해 [Web Worker](./../.././docs/pages/Web%20Worker.md) 사이 메모리를 동기화하기 위해 사용됨.
- Thread-safe.
- Thread 사이 데이터를 복사하지 않아도 됨.
- 이벤트 루프 없이 통신 가능. 빠름.
- 생성자 없음. [Static](./../.././docs/pages/Static%20%28Computer%20Systems%29.md).
