...
- The values for the dynamic viewport do not update at 60fps. In all [browsers](./../.././docs/pages/Web%20Browser.md) updating is throttled as the UA [UI](./../.././docs/pages/UI%20and%20UX.md) expands or retracts. Some [browsers](./../.././docs/pages/Web%20Browser.md) even debounce updating entirely depending on the gesture (a slow scroll versus a swipe) used
- The on-screen keyboard (also known as the virtual keyboard) is not considered part of the UA [UI](./../.././docs/pages/UI%20and%20UX.md)
