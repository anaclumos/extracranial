...
- When reading [JSX](./../.././docs/pages/JSX.md), I am comfortable imagining a 1-to-1 match with the [UI](./../.././docs/pages/UI%20and%20UX.md). I can easily navigate through the component tree and [map](./../.././docs/pages/Map.md) with the reality
...
- Document-like websites, styling content that is structured as a big chunk. Using [Tailwind Typography](https://blog.tailwindcss.com/tailwindcss-typography), it does come with reasonable defaults for raw content like a blog or a [newsletter](./../.././docs/pages/Newsletter.md)
