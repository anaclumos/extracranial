...
- _Not to mention [plaintext protocols](https://matt-rickard.com/the-power-of-plaintext-protocols). [HTTP](./../.././docs/pages/HTTP.md), [SMTP](./../.././docs/pages/SMTP.md), FTP, and Redis Serialization Protocol (RESP) are a few examples_
