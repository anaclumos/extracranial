...
## Dynamic [Memory Allocation](./../.././docs/pages/Memory%20Allocation.md) in C
...
In [Linux](./../.././docs/pages/Linux.md), the `brk` pointer will be adjusted with `sbrk(intptr_t increment)`
...
C and [C++](./../.././docs/pages/C%2B%2B.md) use explicit allocators, which the developers must explicitly free the memory when done using them.
On the other hand, [Java](./../.././docs/pages/Java.md), [Python](./../.././docs/pages/Python.md), or other higher-level languages use implicit allocators, which this memory free-ing is done automatically.
