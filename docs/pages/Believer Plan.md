...
여러분의 성원에 대한 감사의 표시로 전 세계 1,000명 이상의 해커에게 전달할 수 있는 간단한 감사 [메시지](./../.././docs/pages/Text%20Message.md)를 작성할 수 있는 기회가 주어집니다.
...
- '빌리버 플랜'을 구매하신 분의 혜택으로 '해커'들에게 매일 전송되는 뉴스레터에 일회성 [메시지](./../.././docs/pages/Text%20Message.md)를 전송할 수 있는 혜택을 부여하며, 차후 변경될 수 있습니다. [메시지](./../.././docs/pages/Text%20Message.md)에는 인의 생각을 담을 수 있습니다. 공익성 홍보글은 작성할 수 있습니다만 상업적 홍보글은 작성하기 어렵습니다. 이는 회사와 회원의 조율로 합의합니다.
- 회사와 회원의 합의는 [이메일](./../.././docs/pages/Mail.md) 혹은 영상전화로 가능합니다.
- 해당 플랜을 구매하면 2주 내로 [메시지](./../.././docs/pages/Text%20Message.md) 작성 가능하며 [메시지](./../.././docs/pages/Text%20Message.md) 작성 이후 3일 내로 레터에 반영합니다.

## 환불 정책

1. 회원은 회사에 환불을 요구할 수 있습니다. 환불은 회사가 안내하는 정책 및 방법에 따라 진행됩니다.
2. 회사는 다음 각 호의 방식으로 환불을 진행합니다.
   1. '빌리버 플랜'을 구매하신 분의 혜택으로 '해커'들에게 매일 전송되는 뉴스레터에 [메시지](./../.././docs/pages/Text%20Message.md)를 전송하실 경우, 회사와 회원의 합의 하에 지정된 [메시지](./../.././docs/pages/Text%20Message.md) 전송 시간에서 24시간 이전에만 전액 환불이 가능합니다. 그 이후부터는 환불이 불가능합니다.
...
- The agreement between the company and the member can be made via [email](./../.././docs/pages/Mail.md) or video call.
- If you purchase this plan, you can write a message within two weeks, which will be reflected in the [letter](./../.././docs/pages/Mail.md) within three days after the notice is noted.
