...
This is an opinionated guide of implementing [Internationalization](./../.././docs/pages/Internationalization.md) with [Redwood.js](./../.././docs/pages/Redwood.js.md)
...
Below is [hreflang](./../.././docs/pages/hreflang.md) to others, using allowedLanguageList
