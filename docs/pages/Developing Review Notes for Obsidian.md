...
이 문서는 [Obsidian](./../.././docs/pages/Obsidian.md)을 스캐폴딩하는 방법에 대해 다루며 옵시디언 [API](./../.././docs/pages/API.md) 문서를 탐독하면서 이런 저런 발견 사항들을 기록할 것이다.
영어로 작성하려다가 옵시디언 플러그인 개발 자료는 [한국어](./../.././docs/pages/%ED%95%9C%EA%B5%AD%EC%96%B4.md)로 거의 없어 그냥 [한국어](./../.././docs/pages/%ED%95%9C%EA%B5%AD%EC%96%B4.md)로 작성한다.
...
스토어에 올라온 몇몇 플러그인을 보니 다음과 같은 간단한 구조였다. [Chrome](./../.././docs/pages/Chrome.md) [Extension](./../.././docs/pages/WebExtension.md)과 유사하게 번들된 `main.js`와 `manifest.json`으로 이루어져 있다.
...
`manifest.json`에는 다음과 같이 플러그인의 [메타데이터](./../.././docs/pages/Metadata.md)를 넣을 수 있다.
...
옵시디언 [API](./../.././docs/pages/API.md) 문서를 읽다 다음과 같이 파일 구조가 정의됨을 알 수 있었다.
...
옵시디언 [API](./../.././docs/pages/API.md) 문서를 더 읽었다.
...
매번 [익스텐션](./../.././docs/pages/WebExtension.md)을 삭제하고 다시 설치해야 한다.
...
옵시디언 [API](./../.././docs/pages/API.md) 문서를 찾아보다가 다음과 같은 부분을 찾았다.
...
옵시디언의 [API](./../.././docs/pages/API.md) 문서가 자료가 전혀 없이 `obsidian.d.ts`를 [API](./../.././docs/pages/API.md) 문서라고 부르고 있는 상태라 이해에 어려움이 있다.
Discord 서버에 물어보았다.
...
- 옵시디언 [API](./../.././docs/pages/API.md) 문서의 [DX](./../.././docs/pages/DX.md) 매우 불친절
