...
- Equalizer
  - Base Length System
- Optimize [Animations](./../.././docs/pages/Animation.md) (css `will-change`)
...
- I can now make [API](./../.././docs/pages/API.md) requests to find out what I was listening to.
...
All I need to do now is to pack them with an [API](./../.././docs/pages/API.md)-style [JSON](./../.././docs/pages/JSON.md) payload.
