...
- From now on, we must treat anything we see on the Internet as potential [AI](./../.././docs/pages/AI.md) garbage. The picture gallery from an artist? The very cool sounding answer on Stackoverflow? This article in the newspaper? This short viral video? Is this book on [Amazon](./../.././docs/pages/Amazon.md)? They are all potential [AI](./../.././docs/pages/AI.md) garbage
- Fascinating garbage but garbage nonetheless

### [Fake books - lcamtuf's thing](https://lcamtuf.substack.com/p/fake-books)

- I had an epiphany: I was probably looking at the output of an [ML](./../.././docs/pages/ML.md)-based language model, such as GPT-3
