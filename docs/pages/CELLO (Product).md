...
그것의 Consumer-side Product가 [CELLO](./../.././docs/pages/CELLO.md)
...
- [Cloudflare](./../.././docs/pages/Cloudflare.md) for serving high-res images
- Possibly [Deno Deploy](./../.././docs/pages/Deno%20Deploy.md)
- [SwiftUI](./../.././docs/pages/SwiftUI.md)

## Things to consider

- Avoid local confinement, as seen in most [K-Pop App](./../.././docs/pages/K-Pop%20App.md).
- Let's go agile, mainly with [emails](./../.././docs/pages/Mail.md)
