...
- 물가와 [경제 성장](./../.././docs/pages/Economic%20Development.md)이 일어남에 따라 Penalty (벌금, 과태료, etc)도 일정하게 인상되어야 하지 않을까?
- 매년 일괄적으로 법무부와 [경제](./../.././docs/pages/Economy.md) 부처의 협력 아래 벌금 "배수" 인상
...
> 이 법은 [경제](./../.././docs/pages/Economy.md) 사정의 변동에 따른 벌금, 과료 또는 과태료의 금액에 관한 특례를 정함을 목적으로 한다.

### 단점

- Penalty 등과 [경제](./../.././docs/pages/Economy.md) 사정에 큰 괴리가 있을 때 일률적으로 조정하기 위함으로, 정기적으로 이루어지지 않음

## [미국](./../.././docs/pages/United%20States%20of%20America.md)
...
- ![BA8C9D.png](./../.././docs/assets/BA8C9D.png)
