...
A ULID (Universally Unique Lexicographically Sortable Identifier) is a 128-bit identifier that encodes a timestamp and a randomness component into a 26-character, [base32](./../.././docs/pages/Base32.md) string. Its design ensures both global uniqueness and monotonic sort-ability--newer ULIDs will always sort after older ones.
