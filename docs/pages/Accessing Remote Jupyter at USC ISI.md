...
This guide provides instructions for accessing a Jupyter Notebook on a remote server and configuring a GPU for machine learning tasks using TensorFlow and [PyTorch](./../.././docs/pages/PyTorch.md).
...
## Setting Up GPU for [PyTorch](./../.././docs/pages/PyTorch.md)

### Prerequisites

- [PyTorch](./../.././docs/pages/PyTorch.md) installed.
- Knowledge of available GPU numbers.

### Steps for [PyTorch](./../.././docs/pages/PyTorch.md)

1. **Check GPU Availability:**
   - Same as for TensorFlow, use `!nvidia-smi`.

2. **Configure GPU in Notebook:**
   - [PyTorch](./../.././docs/pages/PyTorch.md) automatically uses available GPUs, but you can specify one:
...
- For [PyTorch](./../.././docs/pages/PyTorch.md), `torch.device` is used to specify the GPU.
