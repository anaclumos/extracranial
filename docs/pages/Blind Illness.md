...
> Blind is an app that provides an anonymous forum and community for [verified](./../.././docs/pages/Checkmark.md) employees to discuss issues. Topics, company, and broader industry group users on Blind. The app verifies that the registered users work in the company through their work [email](./../.././docs/pages/Mail.md) and claims to keep user identities untraceable. [Blind (app)](<https://en.wikipedia.org/wiki/Blind_(app)>)
