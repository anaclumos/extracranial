...
When you're an encryption company, so the hero needs to be a [3D](./../.././docs/pages/3D.md) model of the logo rendered as encrypted text.
...
> Weekend side [project](./../.././docs/pages/Project.md). A gallery of the best looking devtool landing pages
>
