...
[2020-04-26](./../.././docs/journals/2020-04-26.md)

If your Ghost [CMS](./../.././docs/pages/CMS.md) blog using Handlebars theme shows published dates in relative time (like _Published 11 months ago_), you will find a handlebars code like this in your theme file.
...
## Further [Readings](./../.././docs/pages/Readings.md)
