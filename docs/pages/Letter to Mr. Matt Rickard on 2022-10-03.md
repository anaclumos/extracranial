...
- Written: [2022-10-03](./../.././docs/journals/2022-10-03.md)
...
That being said, Spotify and [Apple](./../.././docs/pages/Apple.md) Music have a market penetration of next to nothing.

There are two behemoths in Korea, Naver, and [Kakao](./../.././docs/pages/Kakao.md).
Naver services as the omnipotent search engine for Korea (bigger market cap than Google Korea) and [Kakao](./../.././docs/pages/Kakao.md) services as an almighty chatting app (more than 95% of Koreans use it).
They always fight each other for market superiority.

[Kakao](./../.././docs/pages/Kakao.md) currently operates the #1 music streaming service, Melon.
...
- Applying [OCR](./../.././docs/pages/OCR.md) to Naver Vibe, 'moving third-party music list in seconds' [Electronic Times.](https://www-etnews-com.translate.goog/20190410000104?_x_tr_sl=ko&_x_tr_tl=en&_x_tr_hl=en&_x_tr_pto=wapp)
...
## Follow-up on [2022-10-04](./../.././docs/journals/2022-10-04.md)
