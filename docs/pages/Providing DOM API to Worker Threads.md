...
- Provide _synchronous_ [DOM](./../.././docs/pages/DOM.md) [API](./../.././docs/pages/API.md) Access to [Web Worker](./../.././docs/pages/Web%20Worker.md) [Threads](./../.././docs/pages/Threads.md)
- Part of [Brane](./../.././docs/pages/Brane.md)
...
To enable [SharedArrayBuffer](./../.././docs/pages/SharedArrayBuffer.md), we need a secure context `crossOriginIsolated`.

<figure>

![By default, `crossOriginIsolated` is false.](Pasted image 20220728154049.png)

<figcaption>By default, `crossOriginIsolated` is false.</figcaption>
</figure>

To set `crossOriginIsolated` to true, we need two headers.

- [Cross-Origin Opener Policy](./../.././docs/pages/Cross-Origin%20Opener%20Policy.md). `same-origin`
- [Cross-Origin Embedder Policy](./../.././docs/pages/Cross-Origin%20Embedder%20Policy.md). `require-corp`
...
![D351D6.png](./../.././docs/assets/D351D6.png)
...
![84C1D5.png](./../.././docs/assets/84C1D5.png)

</figure>

<figure>

![2968C0.png](./../.././docs/assets/2968C0.png)
...
- Sends [SAB](./../.././docs/pages/SharedArrayBuffer.md) when clicking the _Send SAB to Worker_ button.
  - `[0]` is set to zero, so the heartbeat function waits.
- If _Increment_ button is clicked, [SAB](./../.././docs/pages/SharedArrayBuffer.md) `[0]` is no longer 0.
  - We then notify any function waiting at `[0]`.
- `heart` starts beating, incrementing [SAB](./../.././docs/pages/SharedArrayBuffer.md) `[0]`.

<figure>

![DDD712.png](./../.././docs/assets/DDD712.png)

</figure>

## [Remote Procedure Call](./../.././docs/pages/Remote%20Procedure%20Call.md)

- See [Remote procedure call](https://en.m.wikipedia.org/wiki/Remote_procedure_call)
- _[RPC](./../.././docs/pages/Remote%20Procedure%20Call.md) is a [request-response](https://en.m.wikipedia.org/wiki/Request%E2%80%93response 'Request-response') protocol. An RPC is initiated by the *client*, which sends a request message to a known remote *server* to execute a specified procedure with supplied parameters. The remote server sends a response to the client, and the application continues its process. While the server is processing the call, the client is blocked (it waits until the server has finished processing before resuming execution) unless the client sends an asynchronous request to the server, such as an [XMLHttpRequest](https://en.m.wikipedia.org/wiki/XMLHttpRequest 'XMLHttpRequest')._
...
![EAB9DE.png](./../.././docs/assets/EAB9DE.png)
