...
`AIs.txt` is a mental model of a [machine learning](./../.././docs/pages/ML.md) permission system.
Intuitively, question this: what if we could make a human-readable file that declines [machine learning](./../.././docs/pages/ML.md) (a.k.a. [Copilot](./../.././docs/pages/Copilot.md) use)?
It's like robots.txt, but for [Copilot](./../.././docs/pages/Copilot.md).
...
Technically, [Apple](./../.././docs/pages/Apple.md)'s **App Tracking Transparency** does not ban all tracking activity; it never can.

<figure>

![254AFC.png](./../.././docs/assets/254AFC.png)

</figure>

### Why not `LICENSE` or `COPYING.txt`?

Both are mainly written in human language and cannot provide granular [scraping](./../.././docs/pages/Crawler.md) permissions depending on the collector.
Also, [GitHub](./../.././docs/pages/GitHub.md) Copilot _ignores_ `LICENSE` or `COPYING.txt`,
claiming we consented to Copilot using our codes for [machine learning](./../.././docs/pages/ML.md) by signing up and pushing code to [GitHub](./../.././docs/pages/GitHub.md),
We may expand the `LICENSE` system to include the terms for [machine learning](./../.././docs/pages/ML.md) use,
but that would even more edge case and chaotic licensing systems.

### Does [machine learning](./../.././docs/pages/ML.md) purposes of copyrighted works require a license?
...
[W3](https://www.w3.org/community/tdmrep/) has been working on `robots.txt` for [machine learning](./../.././docs/pages/ML.md), aligning with [EU](./../.././docs/pages/EU.md) Copyright Directives.
...
However, that claim goes against the fundamentals of [intellectual property](./../.././docs/pages/IP.md).
If any [IP](./../.././docs/pages/IP.md) is legally protected, machine-generated code must also have the same level of awareness system to respect it and prevent any plagiarism.
