...
[2022-04-06](./../.././docs/journals/2022-04-06.md)

## Disclaimer

- Both the [United States](./../.././docs/pages/United%20States%20of%20America.md) and the Republic of [Korea](./../.././docs/pages/%EB%8C%80%ED%95%9C%EB%AF%BC%EA%B5%AD.md) allow limited usage of copyrighted material for **educational use**.
...
- After the webpage completes loading--when you can both play the video and scroll through the chat list--open the [browser](./../.././docs/pages/Web%20Browser.md) console.
