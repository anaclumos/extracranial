...
[Databricks](./../.././docs/pages/Databricks.md) Notebooks are analytical tools that can extract information from the data lake.

To create these notebooks on a mass scale, we use templates. The template will be filled out when a user attaches a metric to an experiment and then saved to [Databricks](./../.././docs/pages/Databricks.md).
...
Functions are either in [Python](./../.././docs/pages/Python.md) or [Scala](./../.././docs/pages/Scala.md)
