...
Build an **interaction effects calculator** for [Manakin](./../.././docs/pages/Manakin.md).
...
- [Java](./../.././docs/pages/Java.md), Spring Boot
- TypeScript, React
...
- A way to submit a job that takes:
  ...
  - metric definition
  - range of dates
- A table set up in [Databricks](./../.././docs/pages/Databricks.md) with the proper schema to record the results of each job run
...
- A library that combines given parameters to start a computation job on [Databricks](./../.././docs/pages/Databricks.md)
- Limitations:
