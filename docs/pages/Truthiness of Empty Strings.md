...
On [2023-06-27](./../.././docs/journals/2023-06-27.md), our team at [Grammarly](./../.././docs/pages/Grammarly.md) found a bug where a lot of React components started not working. After investigating for a while, we figured that it came from the recent change where we checked an error with
...
But after we implemented [ESLint](./../.././docs/pages/ESLint.md) in our framework, it started to complain that `Unexpected any value in conditional. An explicit comparison or type cast is required.` So we changed it to convert it to null loosely.
...
![46FC40.png](./../.././docs/assets/46FC40.png)
