...
The set of vertices reachable from source s in the residual graph is one part of the [partition](./../.././docs/pages/Partition.md). Cut capacity $\text{cap}(A, B) = \sum_{\text{out A}} c(e)$.
...
- [3-SAT](./../.././docs/pages/3-SAT.md). Each clause has at most three literals.
