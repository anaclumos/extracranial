...
- [Alternatives](./../.././docs/pages/Alternative.md)
...
### Self-hosted [Google Analytics](./../.././docs/pages/Google%20Analytics.md) [alternatives](./../.././docs/pages/Alternative.md)
...
- Too cold: [Matomo](https://matomo.org/) is only a little more complicated than the [alternatives](./../.././docs/pages/Alternative.md), not by much. It's still quite good. Its interface, [which can be viewed in demo form here](https://demo.matomo.cloud/), is more like [Google Analytics](./../.././docs/pages/Google%20Analytics.md) than the [alternatives](./../.././docs/pages/Alternative.md), but in a way that makes sense.
...
- Outside the box: You could always do with [Mastodon](./../.././docs/pages/Mastodon.md) does and eschew analytics entirely.

### Self-hosted [Email](./../.././docs/pages/Mail.md) newsletter platforms

- Too hot: [Keila](https://www.keila.io), a very-polished-looking [email](./../.././docs/pages/Mail.md) sender that will fit many users' needs, but its emphasis on a single flexible template makes it difficult to recommend for power users. (They are working on it, however--and the team seemed responsive to feedback.) [Sendportal](https://sendportal.io) also has potential, but the fact it hasn't been updated in more than a year gives us pause.
- Too cold: [Mailtrain](https://github.com/Mailtrain-org/mailtrain) has most of the features one might expect out of an [email](./../.././docs/pages/Mail.md)-sending tool, including power-user features like support for MJML, but its user interface can feel imposing to new users. A less-imposing but still-complex [alternative](./../.././docs/pages/Alternative.md) is [Mautic](https://www.mautic.org).
...
- Outside the box: Hosting something through your [CMS](./../.././docs/pages/CMS.md) is a good idea. [Ghost](https://ghost.org), while not anywhere near as full-featured as the other tools mentioned for [email](./../.././docs/pages/Mail.md) use cases, strikes a good balance for the average creator.

### Self-hosted Zapier [alternatives](./../.././docs/pages/Alternative.md)
...
- Outside the box: If your goal is automating some basic tasks, the [browser](./../.././docs/pages/Web%20Browser.md) extension [Automa](https://www.automa.site) also has much potential.

### Self-hosted Calendly [alternatives](./../.././docs/pages/Alternative.md)

- Too hot: [Cal. Com](https://cal.com) has a lot of potential to make many people's lives more accessible; it's not only a helpful tool, but it also appears to be relatively modern and offers a natural [alternative](./../.././docs/pages/Alternative.md) to the dance of trying to book a meeting. That means it is not embarrassing to use when you're trying to set up an appointment. But I'm not recommending it because, at least now, it fails at the fundamental hurdle of being self-hostable, in part. After all, it uses a very temperamental and very modern application stack.
