...
## Registering for [Apple](./../.././docs/pages/Apple.md) Developer Key
...
- By creating a demo website, I could authenticate with my [Apple](./../.././docs/pages/Apple.md) ID and get the User Token.
...
## Testing the [API](./../.././docs/pages/API.md) Key
