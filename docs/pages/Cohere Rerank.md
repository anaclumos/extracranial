...
Cohere의 리랭크는 SaaS [API](./../.././docs/pages/API.md), 클라우드 서비스, 그리고 곧 프라이빗 배포를 통해 사용할 수 있다.
