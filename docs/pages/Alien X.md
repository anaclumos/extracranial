...
![EF81EE.png](./../.././docs/assets/EF81EE.png)

</figure>

Alien X is one of the alien forms that the protagonist, Ben Tennyson, can transform into in the animated television series "[Ben 10](./../.././docs/pages/Ben%2010.md)". This form is part of the transformations available in the Omnitrix, a device worn by Ben that allows him to transform into various alien species.
