...
[WebAssembly](./../.././docs/pages/WebAssembly.md) is a novel way of operating computer instructions at a lower level.
[Assembly](./../.././docs/pages/Assembly.md) is a straightforward way of describing machines to execute instructions.
It follows how [Turing Machine](./../.././docs/pages/Turing%20Machine.md)s would work in the real world.
...
## The binary codes of [WASM](./../.././docs/pages/WebAssembly.md)
...
- [WebAssembly](./../.././docs/pages/WebAssembly.md)'s runtime environments (RE) are low-level virtual stack machines (akin to JVM or Flash VM)
