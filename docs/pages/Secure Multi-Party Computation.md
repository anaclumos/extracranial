...
3. **[Homomorphic Encryption](./../.././docs/pages/Homomorphic%20Encryption.md)**. A kind of encryption that allows computations to be performed on encrypted data without decrypting it.
