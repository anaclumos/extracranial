...
Parquet is a popular file format for use with Big Data processing frameworks such as Hadoop, [Spark](./../.././docs/pages/Apache%20Spark.md), and Impala. It is compatible with most data processing frameworks in the Hadoop echo systems.
...
It is used for [Databricks](./../.././docs/pages/Databricks.md) and [Apache Spark](./../.././docs/pages/Apache%20Spark.md)
