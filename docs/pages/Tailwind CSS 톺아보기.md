...
[2021-07-14](./../.././docs/journals/2021-07-14.md)

## [프로젝트](./../.././docs/pages/Project.md) 목표

- [Tailwind](./../.././docs/pages/Tailwind.md) [CSS](./../.././docs/pages/CSS.md)를 임의의 [TypeScript Next](./../.././docs/pages/Next.js.md) [프로젝트](./../.././docs/pages/Project.md)에 적용
- [Tailwind](./../.././docs/pages/Tailwind.md) [CSS](./../.././docs/pages/CSS.md) 디자인 패턴에 대한 기초적인 이해
- [Tailwind](./../.././docs/pages/Tailwind.md) [CSS](./../.././docs/pages/CSS.md) 디자인 시스템에 대한 기초적인 이해
...
### #0 [프로젝트](./../.././docs/pages/Project.md) 설정

- 기초적인 [TypeScript](./../.././docs/pages/TypeScript.md) [Next](./../.././docs/pages/Next.js.md) App 설정
...
- `./styles/*` 삭제
- `pages/_app.tsx` [CSS](./../.././docs/pages/CSS.md) 관련 코드 삭제 (또는 아래와 같이 입력)
...
- `pages/index.tsx` [CSS](./../.././docs/pages/CSS.md) 관련 코드 삭제 (또는 아래와 같이 입력)
...
## #1 [Tailwind](./../.././docs/pages/Tailwind.md)를 Next에 추가
...
- 최종적으로 Tailwind [CSS](./../.././docs/pages/CSS.md)를 `pages/_app.tsx`에 추가
...
- `next/image` 사용. `next/image`는 여전히 [HTML](./../.././docs/pages/HTML.md) `<img>`를 생성하지만 이미지 최적화 등에서 강점을 지님. 다만 [Tailwind](./../.././docs/pages/Tailwind.md) 자체의 `h-12`, `w-12` 등의 `className`이 지원되지 않아 Wrapper Div가 필요함.
...
### 2\. [Case Study](./../.././docs/pages/Case%20Study.md) Card
...
개인적으로 매우 마음에 들었다. 이전에는 [TypeScript Next에](https://github.com/anaclumos/typescript-next-styled-component) [`styled-component`](https://github.com/anaclumos/typescript-next-styled-component)를 집중적으로 사용했었는데 그에 비한 [Tailwind](./../.././docs/pages/Tailwind.md)의 장점으로 다음 느낌이 들었다.
...
2. 짧아진 코드. 코드가 위아래로 길어지는 것을 방지한다. `styled-component`의 경우 ```으로 [CSS](./../.././docs/pages/CSS.md) 코드를 감싼 후 [CSS](./../.././docs/pages/CSS.md) 코드를 줄바꿈하여 작성하기 때문에 코드가 길어지곤 했었다.
3. 스타일의 변경이 비교적 안전. 스타일을 수정해도 컴포넌트의 `className`을 변경하는 것이기 때문에 다른 컴포넌트의 디자인이 바뀔 일이 없다.
4. 낮은 러닝커브. 예전에는 [Tailwind](./../.././docs/pages/Tailwind.md)의 `className` 속성 이름을 일일이 외워야 하는 줄 알고 러닝커브가 높을 줄 알았는데 대부분의 `className`이 [CSS](./../.././docs/pages/CSS.md) 속성들로 네이밍되어 있을 뿐만 아니라 확장 프로그램을 사용하여 자동완성을 사용하면 됐다.
...
1. Style code를 간편하게 재활용하고 싶은 때가 있다. 예를 들어 `styled-component`로 `StyledButton`를 만든 후 하나의 `tsx` 페이지 안에서 재활용하고 싶은 경우가 있는데 [Tailwind](./../.././docs/pages/Tailwind.md)의 기본적인 사용법으로는 Style code를 빠르게 재활용할 수 없다. 물론 이 문제를 해결하기 위해서는 Template Literal로 코드를 분리해서 사용하면 된다.
2. 코드 `className`의 순서가 섞인다. 이 문제는 [VS Code](./../.././docs/pages/Visual%20Studio%20Code.md)를 사용할 경우 [Headwind](https://marketplace.visualstudio.com/items?itemName=heybourn.headwind)라는 확장 프로그램으로 해결할 수 있다.
