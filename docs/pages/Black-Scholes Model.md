...
- Long story short, you can model the market with [Standard Normal](./../.././docs/pages/Standard%20Normal.md).
- Some assumptions: There's a T-bill (US bond, usually) that gives fixed-rate profit with no danger. The market makes random walks, making a [Standard Normal](./../.././docs/pages/Standard%20Normal.md). The same asset possesses the same value. Free trade with minimum transaction fees.
- Very interesting connections with [Psychohistory](./../.././docs/pages/Psychohistory.md) [심리역사학](./../.././docs/pages/%EC%8B%AC%EB%A6%AC%EC%97%AD%EC%82%AC%ED%95%99.md)

The Black-Scholes Model is a mathematical model used in financial markets to calculate the theoretical price of options, including put and call options. It was developed by economists Fischer Black and Myron Scholes, with notable contributions from Robert Merton. The Black-Scholes formula for a European [call option](./../.././docs/pages/Call%20Option.md) $C$ (an option that can only be exercised at the end of its life) is given as:

$$
C = S_0 e^{-qT}N(d_1) - K e^{-rT}N(d_2)
$$

whereas for a European [put option](./../.././docs/pages/Put%20Option.md) $P$, it is given as:
...
- There are no transaction costs or [taxes](./../.././docs/pages/Tax.md).
