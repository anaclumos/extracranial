...
Opposite of [Call Option](./../.././docs/pages/Call%20Option.md)

This is the right to sell a [stock](./../.././docs/pages/Stock.md) at a certain price before a specific date.
...
[콜 옵션](./../.././docs/pages/Call%20Option.md)의 반대.

정해진 날짜 이전, 특정 가격에 [주식](./../.././docs/pages/Stock.md)을 판매할 수 있는 옵션.
