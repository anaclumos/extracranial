...
아이폰 천지인 자판 프로젝트의 실현 가능성 연구를 통해 제작이 충분히 가능함을 확인.
...
- HTML input 태그에서 `아`를 입력 불가능함. `누`, `노` 등도 불가능함. ← [2023-01-15](./../.././docs/journals/2023-01-15.md) 해결
...
[Subproject](./../.././docs/pages/Subproject.md)로 JSON 집합체를 활자라는 이름으로 배포했다: [anaclumos/hwalja: 활자: 세상에서 가장 단순한 천지인 구현체](https://github.com/anaclumos/hwalja)
