...
- [GitHub](./../.././docs/pages/GitHub.md) profiles are sometimes used for recruiting and resumes. However, professional networks are rarely reflected on the [GitHub](./../.././docs/pages/GitHub.md) follower model compared to LinkedIn (or [Twitter](./../.././docs/pages/Twitter.md)
