...
I am building [Project Ganymede](./../.././docs/pages/Project%20Ganymede.md). It's a social app, but we will build it purely on Apple's iMessage ecosystem. It may sound counterintuitive. Why risk yourself by becoming so platform-dependent?
...
iMessage is a massive system, just like Jupiter. Compared to that, Snapchat, Messenger, and [Instagram](./../.././docs/pages/Meta%20%28Company%29.md) are Mars, Mercury, or... any other planet... small.

Therefore, I choose to become a moon. I will ride on top of Apple. I will be the moon of Jupiter. I will harness the best of the best of Apple. And a moon can grow to a huge scale, just like [Ganymede](./../.././docs/pages/Project%20Ganymede.md) is bigger than Mercury. That is, I can easily outsize mediocre social networks by harnessing the most out of Apple's ecosystem.

We could've named it Project **Remora**, but I think [Ganymede](./../.././docs/pages/Project%20Ganymede.md) is more [aesthetic](./../.././docs/pages/Aesthete.md). Maybe Remora was more straightforward to understand. But hey, you finished reading the manifesto even though I named it [Ganymede](./../.././docs/pages/Project%20Ganymede.md), right? So it worked 😁
...
아이메시지는 목성처럼 거대한 시스템입니다. 그에 비하면 스냅챗, 메신저, [인스타그램](./../.././docs/pages/Meta%20%28Company%29.md)은 화성이나 수성, 또는 다른 행성 정도입니다. 목성에 비하면 아주 작죠.
...
**프로젝트 빨판상어**라고 이름 붙일 수도 있었지만, 가니메데가 더 [심미적](./../.././docs/pages/Aesthete.md)인 것 같아요. 어쩌면 빨판상어가 더 이해하기 쉬웠을지도 모르죠. 그래도 제가 가니메데라고 이름을 지었는데도 선언문은 다 읽으셨잖아요? 그니까 이름 잘 지은거죠 😁
