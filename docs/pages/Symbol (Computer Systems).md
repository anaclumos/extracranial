...
The [linker](./../.././docs/pages/Link%20%28Computer%20Systems%29.md) will arbitrarily select the symbol when there are multiple weak symbols, depending on the implementation.

When dealing with global variables, it is good to

- use `static` if possible
- initialize global variables (take advantage of the [linker](./../.././docs/pages/Link%20%28Computer%20Systems%29.md) for [dx](./../.././docs/pages/DX.md))
