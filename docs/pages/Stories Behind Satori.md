...
We can calculate the elements' positions through a layout [engine](./../.././docs/pages/Engine.md) and convert them into [SVG](./../.././docs/pages/SVG.md) markups.

This is already done by an open-source [project](./../.././docs/pages/Project.md) [facebook/yoga](https://github.com/facebook/yoga).
...
They also added [Google](./../.././docs/pages/Google.md) [Font](./../.././docs/pages/Font.md)'s `?text=` [API](./../.././docs/pages/API.md), containing a specific subset of the [CJK](./../.././docs/pages/CJK.md) library and rendering things on the fly.
The same applies to [emojis](./../.././docs/pages/Emoji.md).
