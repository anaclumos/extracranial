...
- While some reported that the [Chrome](./../.././docs/pages/Chrome.md)/[Firefox](./../.././docs/pages/Firefox.md) version did not work and changing the user agent manually worked, others said changing the user agent did not. Therefore, the methods provided did not work for these few users except for using the native Edge.
...
![38BB75.png](./../.././docs/assets/38BB75.png)

</figure>

<figure>

![FF32E1.png](./../.././docs/assets/FF32E1.png)

</figure>

What the hell, [Bing](./../.././docs/pages/Bing.md)...
