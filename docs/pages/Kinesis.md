...
[Amazon](./../.././docs/pages/Amazon.md) Kinesis is a fully managed service that makes it easy to process and analyze streaming data at any scale. With Kinesis, you can ingest real-time data, such as video, audio, application logs, website clickstreams, and IoT telemetry data, for [machine learning](./../.././docs/pages/ML.md), analytics, and other applications.
