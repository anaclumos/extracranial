...
[Old Someday](./../.././docs/pages/Old%20Someday.md) [Project](./../.././docs/pages/Project.md). Open-sourced [Code Time](https://www.software.com/product/code-time) or [WakaTime](https://wakatime.com/). Time Tracking per language, per repository, per editor, etc

- Self-hostable dashboard server
- Your data, your own (no [paywall](./../.././docs/pages/Fiercely%20Overpriced.md) if self-hosted)
- terminal program gets all the data (the .sh name)
- [JSON](./../.././docs/pages/JSON.md) [API](./../.././docs/pages/API.md)
...
- Both Code Time and Wakatime has serious [paywall](./../.././docs/pages/Fiercely%20Overpriced.md) problem
