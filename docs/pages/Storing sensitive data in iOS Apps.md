...
[2022-04-26](./../.././docs/journals/2022-04-26.md)

## One way that doesn't work: Using environment variables

- If you click the app name from the top bar in [Xcode](./../.././docs/pages/Xcode.md), you can `edit scheme`.
...
- Is it safe? No!
- However, I am using LinkedIn [API](./../.././docs/pages/API.md) that makes a network request.
- Anyone who will take the effort to decompile the app and extract the [API](./../.././docs/pages/API.md) key data will attack the network request and extract the key.
...
- Access your server, download the information via HTTPS, and save it to the [iOS](./../.././docs/pages/iOS.md) secure enclave whenever you need the key.
...
## Advanced [Readings](./../.././docs/pages/Readings.md)
