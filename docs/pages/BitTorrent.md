...
- Notably, I left out all the glue code, parsing, unit tests, and the [boring](./../.././docs/pages/Boring%20Technologies.md) parts that build character. View my [full implementation](https://github.com/veggiedefender/torrent-client) if you're interested
