...
[Old Someday](./../.././docs/pages/Old%20Someday.md) [Project](./../.././docs/pages/Project.md). [Apple](./../.././docs/pages/Apple.md) Pencil Handwriting → [Font](./../.././docs/pages/Font.md).
...
- 영문 폰트 핵심으로
- 아이패드와 [애플](./../.././docs/pages/Apple.md)펜슬만으로 쉽고 빠르게
- PencilKit 적극 활용
- [Apple](./../.././docs/pages/Apple.md) [Neural Engine](./../.././docs/pages/Neural%20Engine.md) 적극 활용, 기기 자체에서 폰트 추론하기
- [Project](./../.././docs/pages/Project.md) 기반 (like Procreate)
- 추출 전 미리보기 (텍스트 쳐보기) 가능
- 추출 전 여러가지 [Font Features](./../.././docs/pages/Font%20Features.md)을 켜고 끄며 미리보기 대조 가능
- 추출 후 [프로젝트](./../.././docs/pages/Project.md)는 Freeze되며 수정할 수 없음. 대신 다운로드 무제한 가능

## [Fiercely Overpriced](./../.././docs/pages/Fiercely%20Overpriced.md)

- 비영리 라이센스 $9.99
- 영리 라이센스 $99.99
- 수정할 수 있는 마스터파일 $299.99 (or [앱스토어](./../.././docs/pages/App%20Store.md) 상한선 있는가?)

## Slack Thread & 리소스

- [periannath/neural-fonts: GAN을 활용한 한글 폰트 제작 프로젝트](https://github.com/periannath/neural-fonts)
- 새로운 나눔손글씨 글꼴 - [네이버](./../.././docs/pages/Naver.md) 클로바: https://clova.ai/handwriting
