...
- an [UI and UX](./../.././docs/pages/UI%20and%20UX.md) experiment.

### [Introducing Magician - by Jordan Singer - Diagram](https://blog.diagram.com/p/introducing-magician)

- [Magician](https://magician.design) is a [Figma](./../.././docs/pages/Figma.md) plugin that lets you design with the power of [AI](./../.././docs/pages/AI.md) to do everything from copywriting to generating unique icons from the text. Each magic spell works alongside you to expand your creativity and imagination as you design
