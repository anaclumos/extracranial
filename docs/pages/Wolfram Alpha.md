...
## Wolfram's [ChatGPT](./../.././docs/pages/ChatGPT.md) prompt
...
- To solve for a variable in an equation with units, consider solving a corresponding equation without units; exclude [counting](./../.././docs/pages/Counting.md) units (e.g., books), include genuine units (e.g., kg).
...
- If unevaluated Wolfram Language symbols appear in [API](./../.././docs/pages/API.md) results, use `EntityValue[Entity[\"WolframLanguageSymbol\",symbol],{\"PlaintextUsage\",\"Options\"}]` to validate or retrieve usage information for relevant symbols; `symbol` may be a list of symbols.
