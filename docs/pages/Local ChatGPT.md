...
- [LLaMA](./../.././docs/pages/LLaMA.md)
  - Somewhat surprisingly, language models like GPT-3 that power tools like [ChatGPT](./../.././docs/pages/ChatGPT.md) are a lot larger and more expensive to build and operate than image generation models
  - [LLaMA](./../.././docs/pages/LLaMA.md) on its own isn't much good if it's still too hard to run it on a personal laptop
