...
- Currently works at [Apple](./../.././docs/pages/Apple.md), [Apple](./../.././docs/pages/Apple.md) Silicon Team
- Studied Electrical Engineering in school
  - Took a lot of science classes
  - [MS](./../.././docs/pages/Microsoft.md) in Chips
- Works as an SoC Engineer
  - Joined the M1 team just before the announcement
  - Worked on the A16 chip this year (2022)
- _[Apple](./../.././docs/pages/Apple.md) Silicon Team_ isn't necessarily a hardware team
...
- One downside: [Apple](./../.././docs/pages/Apple.md) is a very secretive company.
  - Every permission is on a _need-to-know_ basis.
  - Siloed Culture.
  - However, communications are very active across the team.
- If I leave [Apple](./../.././docs/pages/Apple.md)
...
[Apple](./../.././docs/pages/Apple.md) also has a sound responsibility system -- e.g., DRI.
</Callout>
