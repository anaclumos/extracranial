...
The original page, [Attention Settings](https://attentionsettings.com/), is now inaccessible, and this page is only for [Data Preservation](./../.././docs/pages/Data%20Preservation.md) purposes.
...
![E9DA32.png](./../.././docs/assets/E9DA32.png)
...
![6DE1DE.png](./../.././docs/assets/6DE1DE.png)

</figure>

<figure>

![346C75.png](./../.././docs/assets/346C75.png)

</figure>

<figure>

![58745C.png](./../.././docs/assets/58745C.png)
...
![8DE1B4.png](./../.././docs/assets/8DE1B4.png)
...
![8F9A20.png](./../.././docs/assets/8F9A20.png)
...
![ACCDE7.png](./../.././docs/assets/ACCDE7.png)
...
![EEC7D4.png](./../.././docs/assets/EEC7D4.png)
...
1. Privileged Information: With sophisticated psychological profiles, thousands of data points, and years of [meta](./../.././docs/pages/Meta.md)-data on every user, social media companies have a comprehensive set of privileged information.
...
<figcaption>Reduce Time Spent via Mindful App Openings and Alternative Activities</figcaption>
</figure>
...
### Give [Researchers](./../.././docs/pages/Researcher.md) Access to Screen Time Data
...
### ScreenTime [API](./../.././docs/pages/API.md) and AttentionKit

Apple could share the current Focus mode, Screen Time schedule and events (eg. the user has been on for 20 minutes) via the ScreenTime [API](./../.././docs/pages/API.md).
...
1. 특권 정보: 정교한 심리 프로파일, 수천 개의 데이터 포인트, 모든 사용자에 대한 수년간의 [메타](./../.././docs/pages/Meta.md) 데이터를 가진 소셜 미디어 회사는 포괄적인특권 정보 집합을 가지고 있다.
...
<figcaption>Minding App Opening 및 대체 활동을 통해 소요 시간 단축</figcaption>
</figure>

iOS는 사용자들에게 주의력을 산만하게 하는 앱들을 계속하기 전에 마음을 사로잡는 순간을 즐길 수 있는 옵션을 제공할 수 있으며, 마음을 빼앗기지 않는 스크롤보다 더 매력적인 활동들을 시리를 통해 제안할 수 있다.

이미 [one sec](https://one-sec.app/) 또는 [Potential](https://potential.app/)과 같은 앱에서 이러한 경험을 할 수 있지만, 이는 어느 정도의 설정이 필요하며 애플이 구축할 수 있는 것보다 덜 이상적인 UX이다. 더욱 좋은 점은, 애플이 어텐션 키트를 제공하고 개발자들이 ScreenTime [API](./../.././docs/pages/API.md)의 데이터에 기반하여 다른 앱 위에 이와 같은 모드를 트리거할 수 있도록 권한을 부여할 수 있다는 것이다.
...
### ScreenTime [API](./../.././docs/pages/API.md) 및 Attention Kit

애플은 ScreenTime [API](./../.././docs/pages/API.md)를 통해 현재 포커스 모드, ScreenTime 스케줄 및 이벤트(예: 사용자가 20분 동안 기기를 사용하고 있음)를 공유할 수 있다.
