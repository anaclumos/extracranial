...
- [Artifact](./../.././docs/pages/Artifact.md) can feel like a throwback. Inspired by TikTok's success, big social platforms have spent the past few years chasing short-form video products and the ad revenue that comes with them
- The tech that enabled [ChatGPT](./../.././docs/pages/ChatGPT.md) also created new possibilities for social networks
- [Artifact](./../.././docs/pages/Artifact.md) will take the job of serving readers with high-quality news and information seriously
