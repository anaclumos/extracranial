...
![A9751C.png](./../.././docs/assets/A9751C.png)

</figure>

그 이후에도 수많은 시도가 있었다. [민사고](./../.././docs/pages/%EB%AF%BC%EC%82%AC%EA%B3%A0.md)에는 [KMLA Online](./../.././docs/pages/KMLA%20Online.md)이라는 인트라넷이 있는데, 처음에는 거기에 합류해서 앱 버전으로 개편할 계획을 가지고 있다가, 과제 마감 기한을 맞추지 못해 불합격된 이후로 오기가 생겨 경쟁적 서비스를 출시해서 [KMLA Online](./../.././docs/pages/KMLA%20Online.md)과 [페이스북](./../.././docs/pages/Meta%20%28Company%29.md) 그룹들의 입지를 전략적 Overtake하려는 계획에까지 이르게 된다. 2017년에는 KMLA Assistant라는 챗봇으로 만들 생각을 하다가 ([Demise of Chatbots in 2017](./../.././docs/pages/Demise%20of%20Chatbots%20in%202017.md)) 2018년에는 웹 혹은 플러터 버전으로 만들 생각을 했고, 2019년에는 현실적인 한계들을 알게 되고 어쨌든 그 아이디어들은 훗날 민사페이와 AP Studio Art 최종 앱 디자인 과제에 백서 형태로 제출하며 어느 정도 결실을 맺게 된다.
...
의 구분점과 시사점에 대한 생각을 해볼 단초를 제공해줬다. 나는 **소프트웨어가 좋아**랑 **소프트웨어는 무조건 좋은거야**를 10대 시절에는 구분에 어려움을 겪었기 때문이다. 독극물적인 소프트웨어가 사람의 정신을 잠식해 나가는 것을 느끼고 있었음에도 기술의 무조건적 확장은 좋은 것이라고 옹호했었다. 하지만, 사람을 이롭게 하는 기술과 사람을 정복하는 트로이 목마적인 기술은 별개라는 사실을 점차 깨달았다. [디지털 중독](./../.././docs/pages/Digital%20Addiction.md) 참고.

어쨌든, [Attention Settings](./../.././docs/pages/Attention%20Settings.md)과 비슷한 나만의 프레임워크를 만들기 위해서 노력했다. 편리함은 최대로, 그 편리함으로 인간성을 잠식하지 말 것. 인간 사고의 번영을 위해서 소프트웨어는 온전히 사람을 보조할 것. [소셜 엔지니어링 금지](./../.././docs/pages/%EC%86%8C%EC%85%9C%20%EC%97%94%EC%A7%80%EB%8B%88%EC%96%B4%EB%A7%81%20%EA%B8%88%EC%A7%80.md)
...
![FC60E6.png](./../.././docs/assets/FC60E6.png)

</figure>

## Bring back your campus life and escape social media

Since 2013, [KMLA](./../.././docs/pages/%EB%AF%BC%EC%82%AC%EA%B3%A0.md) students used social media for internal communication. It worked, but social media were designed to distract and zombify us.
...
![D13070.png](./../.././docs/assets/D13070.png)
...
![B55B1C.png](./../.././docs/assets/B55B1C.png)
...
![D9A6F1.png](./../.././docs/assets/D9A6F1.png)
...
![196886.png](./../.././docs/assets/196886.png)
...
Although the app remembers your personal information, only you can view your sensitive information. Less sensitive data that could help the community are only open to the [KMLA](./../.././docs/pages/%EB%AF%BC%EC%82%AC%EA%B3%A0.md) Family. All the data are securely encrypted and stored on the server.

<figure>

![552CE3.png](./../.././docs/assets/552CE3.png)
...
![FCC18C.png](./../.././docs/assets/FCC18C.png)
...
![BEFFDF.png](./../.././docs/assets/BEFFDF.png)

</figure>

### Your macgyver knife.

The app provides more tools to make [KMLA](./../.././docs/pages/%EB%AF%BC%EC%82%AC%EA%B3%A0.md) life much more comfortable.
...
### [KMLA](./../.././docs/pages/%EB%AF%BC%EC%82%AC%EA%B3%A0.md) Wikipedia

Our version of Wikipedia, with a document describing the entire history of [KMLA](./../.././docs/pages/%EB%AF%BC%EC%82%AC%EA%B3%A0.md), is accessible here. Every student and teacher can contribute to the [KMLA](./../.././docs/pages/%EB%AF%BC%EC%82%AC%EA%B3%A0.md) Wikipedia.
...
![A0314B.png](./../.././docs/assets/A0314B.png)
...
2013년부터 [민사고](./../.././docs/pages/%EB%AF%BC%EC%82%AC%EA%B3%A0.md) 학생들은 학내 커뮤니케이션을 위해 소셜 미디어를 사용했습니다. 효과는 있었지만 소셜 미디어는 우리의 주의를 분산시키고 좀비화하도록 설계되었습니다.
...
앱이 사용자의 개인 정보를 기억하지만 민감한 정보는 본인만 볼 수 있습니다. 커뮤니티에 도움이 될 수 있는 덜 민감한 데이터는 [민사고](./../.././docs/pages/%EB%AF%BC%EC%82%AC%EA%B3%A0.md) 가족에게만 공개됩니다. 모든 데이터는 안전하게 암호화되어 서버에 저장됩니다.
...
이 앱은 [민사고](./../.././docs/pages/%EB%AF%BC%EC%82%AC%EA%B3%A0.md) 생활을 훨씬 더 편안하게 만들어주는 더 많은 도구를 제공합니다.
...
### [민사고](./../.././docs/pages/%EB%AF%BC%EC%82%AC%EA%B3%A0.md) 위키백과

[민사고](./../.././docs/pages/%EB%AF%BC%EC%82%AC%EA%B3%A0.md)의 전체 역사를 설명하는 문서가 포함된 위키백과 버전은 여기에서 액세스할 수 있습니다. 모든 학생과 교사는 [민사고](./../.././docs/pages/%EB%AF%BC%EC%82%AC%EA%B3%A0.md) 위키백과에 기여할 수 있습니다.
