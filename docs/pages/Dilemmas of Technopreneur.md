...
> If you are in a competitive [VC](./../.././docs/pages/Venture%20Capital.md)-funded space, it's foolish to compete without raising money. Don't bring a knife to a gun fight. [Andrew Wilkinson (@awilkinson)](https://twitter.com/awilkinson)
...
There are dozens of examples, like the early days of Mark Zuckerberg, the creators of [Obsidian](./../.././docs/pages/Obsidian.md), or even Mr. Levels.
...
He had the talent and could make a full-blown product, but it never would've become [Apple](./../.././docs/pages/Apple.md) if it weren't for Steve Jobs.
