...
See also: [Real Exams](./../.././docs/pages/Real%20Exams.md)

[Source](https://www.reddit.com/r/ProgrammerHumor/comments/l6wnvt/interview_vs_job/)

<figure>

![30E62A.png](./../.././docs/assets/30E62A.png)
...
- Learned that [Grammarly](./../.././docs/pages/Grammarly.md) has internal projects, Readerly (summarizing) and Speakerly ([Generative Intelligence](./../.././docs/pages/Generative%20Intelligence.md))

### [Palantir](./../.././docs/pages/Palantir.md) with [Karat](https://karat.com/)
...
### [Databricks](./../.././docs/pages/Databricks.md)
