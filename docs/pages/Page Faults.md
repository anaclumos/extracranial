...
- operating system will
  ...
  - make sure page table and [translation look-aside buffers](./../.././docs/pages/Translation%20Look-aside%20Buffers.md) are updated
- when evicting...
...
| [Translation Look-aside Buffers](./../.././docs/pages/Translation%20Look-aside%20Buffers.md) | [Virtual Memory](./../.././docs/pages/Virtual%20Memory.md) | Cache | Possible?                                                       |
| -------------------------------------------------------------------------------------------- | ---------------------------------------------------------- | ----- | --------------------------------------------------------------- |
