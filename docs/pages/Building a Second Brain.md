...
[2022-07-07](./../.././docs/journals/2022-07-07.md)
...
The origin goes back to the [commonplace book](./../.././docs/pages/Commonplace%20Book.md) used by ancient scholars.
They always carried a [commonplace book](./../.././docs/pages/Commonplace%20Book.md), taking notes like a canvas synced with their brain.
The so-called [second brain](./../.././docs/pages/Second%20Brain.md) is recreating the same concept on a digital device.
...
A [second brain](./../.././docs/pages/Second%20Brain.md) can:
...
Organizing was similar to Data Structures in [Computer Science](./../.././docs/pages/Computer%20Science.md).
...
I simplified it into Projects, Research, and [Readings](./../.././docs/pages/Readings.md).
The author claimed that classifying such things as [Readings](./../.././docs/pages/Readings.md) and Quotes as their own is like organizing food ingredients by their color.
However, I think it makes sense to occasionally separate [Readings](./../.././docs/pages/Readings.md).
