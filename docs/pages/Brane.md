...
- Parties that create [browsers](./../.././docs/pages/Web%20Browser.md) do not own these limitations; Brane aims to democratize these privileges from mega-corporates creating [browsers](./../.././docs/pages/Web%20Browser.md) to Super App developers, who are much smaller in scale.
