...
- CDN Up and Running
- This repo aims to build a body of knowledge on how CDNs work by coding one from "scratch". The CDN we will design uses: Nginx, Lua, [docker](./../.././docs/pages/Docker.md), [docker](./../.././docs/pages/Docker.md)-compose, Prometheus, grafana, and wrk.
- We'll start creating a single [backend](./../.././docs/pages/Back-end.md) service and expand to a multi-node, latency-simulated, observable, and testable CDN. In each section, there are discussions regarding the challenges and trade-offs of building/managing/operating a CDN
