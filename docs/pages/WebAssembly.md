...
[Assembly](./../.././docs/pages/Assembly.md) languages in general consists of simple and atomic operations that the processor can follow.
...
We can convert this C code into [WebAssembly](./../.././docs/pages/WebAssembly.md) with a build tool called [Emscripten](https://emscripten.org/index.html).
...
![8692F9.png](./../.././docs/assets/8692F9.png)
...
![56155E.png](./../.././docs/assets/56155E.png)
...
- Binding a low-level sqlite3 [API](./../.././docs/pages/API.md) which is as close to the C one as feasible in terms of usage.
- A higher-level object-oriented [API](./../.././docs/pages/API.md), more akin to [sql. js](https://github.com/sql-js/sql.js/) and [Node. Js-style implementations](https://www.npmjs.com/package/sqlite3) speak directly to the low-level [API](./../.././docs/pages/API.md). This [API](./../.././docs/pages/API.md) must be used from the same thread as the low-level [API](./../.././docs/pages/API.md).
- A Worker-based [API](./../.././docs/pages/API.md) that speaks to the previous APIs via Worker messages. This one is intended for use in the main thread, with the lower-level APIs installed in a [Worker thread](./../.././docs/pages/Web%20Worker.md) and talking to them via Worker messages.
- A Promise-based variant of the Worker [API](./../.././docs/pages/API.md) that entirely hides the cross-thread communication aspects from the user.
