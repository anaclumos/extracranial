...
- Manhattan boasts the state's highest percentage of residents - more than 80 percent - earning a living wage. But a closer look at New York City presents a picture of [economic](./../.././docs/pages/Economy.md) inequality, with median effective hourly wages ranging from more than USD 50 in some Manhattan neighborhoods to USD 20 or less in some nearby communities
