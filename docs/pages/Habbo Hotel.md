...
Habbo Hotel is also a part of the [metaverse](./../.././docs/pages/Metaverse.md). It is a virtual world and social networking site where users can create and customize their avatars, chat with friends, and participate in various activities and games. In addition, Habbo Hotel has recently opened a new resort in the Sandbox [metaverse](./../.././docs/pages/Metaverse.md), a decentralized platform where users can create, own, and monetize their voxel gaming experiences.
