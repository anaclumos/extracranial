...
- _You are the top banker in charge of the central bank. Your role is to maximize [economic](./../.././docs/pages/Economy.md) potential by putting the right amount of money in circulation to increase the GDP of your village: the number of apples it produces. Your only lever changes the central bank interest rate. Good luck!_
...
- [younho9 Blog](https://www.notion.so/younho9-Blog-9ed630c8603541bab20662b4854a891f)
  - Not surprisingly, the dev behind this website moved his [digital garden](./../.././docs/pages/Digital%20Garden.md) to [here](https://notes.younho9.com/). Splendid website, made with VuePress.
