...
- Add easing to your [Animation](./../.././docs/pages/Animation.md) to help add a responsive and natural feel.
- Quick, light, and snappy [Animation](./../.././docs/pages/Animation.md) are less distracting and intrusive for users.
- Use springs to respond to user interaction and provide realistic feedback
- Guide users through an [animation](./../.././docs/pages/Animation.md) by thoughtfully timing out the motion.
- Be purposeful with [Animation](./../.././docs/pages/Animation.md). Only include motion to support the user's experience. Unnecessary motion distracts users.

### [UI](./../.././docs/pages/UI%20and%20UX.md) Design Example By [sulley (@svlleyy)](https://twitter.com/svlleyy)
