...
- [API](./../.././docs/pages/API.md) [Shimming](./../.././docs/pages/Shim.md) will be hard enough. [Shim (computing)](<https://en.wikipedia.org/wiki/Shim_(computing)>)
...
- **Objective**. Swap [WorkerDOM](./../.././docs/pages/WorkerDOM.md)'s data transfer layer with [SharedArrayBuffer](./../.././docs/pages/SharedArrayBuffer.md) + [Shim](./../.././docs/pages/Shim.md) Core [DOM](./../.././docs/pages/DOM.md) APIs.
...
- Especially, try implementing synchronous Layout properties--for example, [Framer Motion](./../.././docs/pages/Framer%20Motion.md).
  - To push the limits, we can try [Kakao](./../.././docs/pages/Kakao.md) [Map](./../.././docs/pages/Cartography.md) SDK (or any [Map](./../.././docs/pages/Cartography.md) SDK like Open Layer)
  - This will essentially verify three facts:
    ...
    3. Can we **[shim](./../.././docs/pages/Shim.md)** geolocation APIs?
...
- In the same vein, I am reading [Building a Second Brain](./../.././docs/pages/Building%20a%20Second%20Brain.md) these days.
