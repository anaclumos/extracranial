...
- If the system fails, the landlord has to fix it and provide you with an [alternative](./../.././docs/pages/Alternative.md) method of entering the building and your apartment. Put your complaints about the problems in writing. If the landlord fails to address them immediately, file a complaint with the New Rochelle bureau of buildings.
