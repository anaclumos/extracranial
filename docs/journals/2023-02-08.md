...
- [Atopic Zeropoint](./../.././docs/pages/Atopic%20Zeropoint.md)
- [Karrot NX Team Mission Statement](./../.././docs/pages/Karrot%20NX%20Team%20Mission%20Statement.md)
- [Powerfully Powerless Tools](./../.././docs/pages/Powerfully%20Powerless%20Tools.md)
- [강력하게 미약한 도구들](./../.././docs/pages/%EA%B0%95%EB%A0%A5%ED%95%98%EA%B2%8C%20%EB%AF%B8%EC%95%BD%ED%95%9C%20%EB%8F%84%EA%B5%AC%EB%93%A4.md)

<figure>

![E8341D.png](./../.././docs/assets/E8341D.png)
...
- Companies building foundational models have partnered with cloud providers: [OpenAI](./../.././docs/pages/OpenAI.md) ([Microsoft](./../.././docs/pages/Microsoft.md)) and Anthropic ([Google](./../.././docs/pages/Google.md)). These companies spend vast amounts on computing to train the models, but their biggest customer will also be their biggest vendor. Weird incentives abound
- Is chat even a promising paradigm for search?

### [Nintendo Will Pay Its Workers 10 percent More - GameSpot](https://www.gamespot.com/articles/nintendo-will-pay-its-workers-10-more/1100-6511268/)

- Nintendo plans to raise its employees' base pay by 10 percent this year in the wake of inflation. [Reuters](https://www.reuters.com/technology/nintendo-trims-annual-profit-outlook-firmer-yen-2023-02-07/?rpc=401&) reported that Nintendo plans to raise salaries even as it reduced its profit expectation for the year. Nintendo previously cut its operating profit forecast from a projected 582 billion yen to 480 billion yen USD 3.6 billion
...
- Search across a half million [git](./../.././docs/pages/Git.md) repos

### [How We Reduced Our iOS App Launch Time by 60 percent](https://doordash.engineering/2023/01/31/how-we-reduced-our-ios-app-launch-time-by-60/)
...
- That is where good performance tools help highlight bottlenecks and surface them. [Xcode](./../.././docs/pages/Xcode.md) instruments, a part of [Xcode](./../.././docs/pages/Xcode.md), come with several templates to help pinpoint various potential issues in a [macOS](./../.././docs/pages/macOS.md)/[iOS](./../.././docs/pages/iOS.md) application
