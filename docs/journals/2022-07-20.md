...
- The client must know what each field indicates to parse a [JSON](./../.././docs/pages/JSON.md) response. Therefore, the message is not self-describing
- [JSON](./../.././docs/pages/JSON.md) response _fails the uniform interface constraint of REST and, thus, is not RESTful_.

But I still prefer [JSON](./../.././docs/pages/JSON.md) APIs, aye?

### [carbon-language/carbon-lang: Carbon language specification and documentation.](https://github.com/carbon-language/carbon-lang)

A successor language for [C++](./../.././docs/pages/C%2B%2B.md) requires:

- Performance matching [C++](./../.././docs/pages/C%2B%2B.md)
- Bidirectional [Interoperability](./../.././docs/pages/Interoperability.md) with [C++](./../.././docs/pages/C%2B%2B.md)
- Gentle learning curve for [C++](./../.././docs/pages/C%2B%2B.md) Developers
- Comparable Expressivity and Support for Existing Design.
- Scalable migration for idiomatic [C++](./../.././docs/pages/C%2B%2B.md) code.

_With this approach, we can build on [C++](./../.././docs/pages/C%2B%2B.md)'s existing ecosystem and bring along existing investments, codebases, and developer populations._ Examples:

- [JavaScript](./../.././docs/pages/JavaScript.md) → [TypeScript](./../.././docs/pages/TypeScript.md)
- [Java](./../.././docs/pages/Java.md) → Kotlin
- [C++](./../.././docs/pages/C%2B%2B.md) → _Carbon_
