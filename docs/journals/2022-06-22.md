...
- Use a variant of [WorkerDOM](./../.././docs/pages/WorkerDOM.md) inside.
  ...
  - the question revolves: what [DOM](./../.././docs/pages/DOM.md) [API](./../.././docs/pages/API.md) should [WorkerDOM](./../.././docs/pages/WorkerDOM.md) support?
...
Preferably, [WorkerDOM](./../.././docs/pages/WorkerDOM.md) and [Web Worker](./../.././docs/pages/Web%20Worker.md) [API](./../.././docs/pages/API.md) will already have a _non-blocking operation_ feature.
Needs confirmation.
...
Deno envisions a [Vercel](./../.././docs/pages/Vercel.md)-like experience for the [backend](./../.././docs/pages/Back-end.md) (FaaS.)
