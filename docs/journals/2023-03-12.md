...
- [SVB Debacle](./../.././docs/pages/SVB%20Debacle.md)
- [Local ChatGPT](./../.././docs/pages/Local%20ChatGPT.md)
- [On-Premise](./../.././docs/pages/On-Premise.md)
...
- Unlike fluffy thought pieces on how [CHATGPT](./../.././docs/pages/ChatGPT.md) WILL CHANGE EVERYTHING
- Playing with this `system` rule can stop [ChatGPT](./../.././docs/pages/ChatGPT.md) from complaining it's "an AI language model and can't answer requests," such as scolding it like the petulant child it is.
- But in making the [ChatGPT](./../.././docs/pages/ChatGPT.md) [API](./../.././docs/pages/API.md) so cheap, they made their $20/month subscription to [ChatGPT+](https://techcrunch.com/2023/02/01/openai-launches-chatgpt-plus-starting-at-20-per-month/) redundant. The main perk of [ChatGPT](./../.././docs/pages/ChatGPT.md)+ was faster and more consistent access to the [ChatGPT](./../.././docs/pages/ChatGPT.md) web [UI](./../.././docs/pages/UI%20and%20UX.md), but unless you are somehow generating more than 10,000,000 tokens in a month through manual use, it's massively cheaper to use the [API](./../.././docs/pages/API.md), and as a bonus, you can modify the `system` prompt to get a better signal-to-noise
