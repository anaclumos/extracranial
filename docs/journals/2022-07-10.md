...
- Convert from English to RegEx with [Natural Language Processing](./../.././docs/pages/Natural%20Language%20Processing.md)
- Uses [GPT](./../.././docs/pages/Generative%20Pre-trained%20Transformer.md) to convert the [natural language](./../.././docs/pages/Natural%20Language.md) to RegEx.
