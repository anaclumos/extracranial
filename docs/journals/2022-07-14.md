...
## Today's [Pragmatic Engineer](./../.././docs/pages/Pragmatic%20Engineer.md)
...
**Gray areas and More**. There are also gray areas like strategic investments, net-loss research teams, platform teams, R&D labs, site reliability engineering, open-source teams, security teams, and more. One wrong info that I found: Uber didn't make [Kubernetes](./../.././docs/pages/Kubernetes.md). [Google](./../.././docs/pages/Google.md) did.

## Personal

### The _Overpriced_ Initiative?

- Moved to [Fiercely Overpriced](./../.././docs/pages/Fiercely%20Overpriced.md)
