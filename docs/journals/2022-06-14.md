...
- [Brane](./../.././docs/pages/Brane.md)에서 [Brane](./../.././docs/pages/Brane.md) [DOM](./../.././docs/pages/DOM.md)을 만드는 것은 구현 전략의 일부일 뿐, [Brane](./../.././docs/pages/Brane.md) [DOM](./../.././docs/pages/DOM.md) 자체는 [Brane](./../.././docs/pages/Brane.md)이 아니다.

## 목표 설정

- [Brane](./../.././docs/pages/Brane.md) [DOM](./../.././docs/pages/DOM.md)의 재구현이 의미가 있는지 실험하고, 유의미한 전략인지 확인하는 것이 목표이다.
...
- 이 가상화 환경의 런타임을 수립할 세부 전략을 세워야 한다.
  - 이 세부 전략으로 [WorkerDOM](./../.././docs/pages/WorkerDOM.md)을 쓸 수도 있고, 고쳐서 쓸 수도 있고, 새로 만들 수도 있고, 폐기할 수도 있는 것이다.
...
- 당근 베타 [프로젝트](./../.././docs/pages/Project.md)에서 Karrot Frame 데모 앱을 돌려보며 터지던 부분들을 나열해 보았다.
