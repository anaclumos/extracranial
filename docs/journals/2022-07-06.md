...
- contact [mail](./../.././docs/pages/Mail.md) and signup [mail](./../.././docs/pages/Mail.md) -- separation necessary?
...
- Implemented the Technical [Proof of Concept](./../.././docs/pages/Proof%20of%20Concept.md) and posted here: _[PoC](./../.././docs/pages/Proof%20of%20Concept.md) that two [WorkerDOM](./../.././docs/pages/WorkerDOM.md) upgraded [threads](./../.././docs/pages/Threads.md) don't block each other_ - [Two Roots](https://brane.vercel.app/two-roots-with-infinite-loop/)
...
- Bundle, transpile, install and run [JavaScript](./../.././docs/pages/JavaScript.md) & [TypeScript](./../.././docs/pages/TypeScript.md) projects -- all in Bun. Bun is a new [JavaScript](./../.././docs/pages/JavaScript.md) runtime with a native bundler, transpiler, task runner and [npm](./../.././docs/pages/NPM.md) client built-in
