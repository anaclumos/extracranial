...
[Animation](./../.././docs/pages/Animation.md) in [JavaScript](./../.././docs/pages/JavaScript.md) requires synchronous layout calculation because it depends on values that could only be found after [DOM Reflow](./../.././docs/pages/DOM%20Reflow.md).
...
[WorkerDOM](./../.././docs/pages/WorkerDOM.md) cannot handle [animation](./../.././docs/pages/Animation.md) libraries because it lacks synchronous [API](./../.././docs/pages/API.md) support.
...
2. **[Atomics (JavaScript)](./../.././docs/pages/Atomics%20%28JavaScript%29.md) [API](./../.././docs/pages/API.md)**. Use `wait()` and `notify()` for blocking constructs.

To automatically use [Atomics (JavaScript)](./../.././docs/pages/Atomics%20%28JavaScript%29.md) [API](./../.././docs/pages/API.md) for every third-party app, [Brane](./../.././docs/pages/Brane.md) should **_abstract_** this process.
...
- Geolocation _might_ be easier, because it is an asynchronous [API](./../.././docs/pages/API.md).
