...
export const Route = createFileRoute("/ko/r/$slug")({
	loader: ({ params }) => {
		...
		if (params.slug !== upperSlug) {
			throw redirect({ to: "/ko/r/$slug", params: { slug: upperSlug } });
		}
...
function ContentPage() {
	...
	return (
		<div className="mx-auto flex max-w-7xl px-4">
			<DocSidebar basePath="/ko/r" currentSlug={slug} docs={allDocs} />
			...
			<BacklinksSidebar backlinks={backlinks} basePath="/ko/r" />
		</div>
	);
}
