...
const CONTENTS: Content[] = [
  ...
  },
  {
    ...
    ko: '저는 a11y(접근성)와 i18n(국제화)에 대한 집착에 가까운 관심을 가지고 있습니다. 이유는 크게 두 가지입니다. 첫째, 제가 미국에서 생활할 때 현지 문화나 언론에 접근할 때 문턱을 느낀 경험이 있습니다. 주변의 뛰어난 한국인 친구들이 언어 장벽으로 기회를 놓치는 모습을 보며, 언어 장벽이 의도치 않게 새로운 형태의 차별이 될 수 있다는 생각을 하게 되었습니다. 둘째, 접근성과 국제화를 잘 고려한 제품일수록 장인정신과 배려심, 그리고 꼼꼼함이 담겨 있다고 생각합니다. a11y나 i18n을 소홀히 한 제품은 대개 기대만큼 훌륭하지 못하다는 판단을 하고 있습니다.',
  },
  {
