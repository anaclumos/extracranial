...
const CONTENTS: Content[] = [
  ...
  {
    en: 'I love lateral thinking (thinking outside the box) and crazy ideas. For example, how can you say, "Shooting rockets are too expensive," then "OK, just land them and reuse them." When paired with exceptional engineering talents, lateral thinking can make amazing breakthroughs regardless of field.',
    ko: '저는 상식을 뒤집는 "수평적 사고"와 독특한 아이디어를 매우 좋아합니다. "로켓 발사가 너무 비싸다"라는 말에 "그렇다면 착륙시켜 재활용하면 되지 않겠습니까!"라고 응수하는 발상이 바로 그 예입니다. 훌륭한 엔지니어링 능력과 결합된다면 어느 분야에서든 멋진 혁신을 이끌어낼 수 있다고 생각합니다.',
  },
  {
    en: 'I am an early adopter and enthusiast in many fields. I love trying out half-baked products and early-stage prototypes. We must explore fresh ideas and converse on them as scientists and engineers. Alas, someone needs to fund them to improve the product, and if so, that better be me! As a great perk other than helping them build the future, I think of those prices expedition costs for ideas, not a price tag of a product. I get ideas from them like, "Oh shit, they nailed this part" or "Oh no, this they missed the potential," and imagine how I would\'ve done it. If you\'re building something extraordinary, you can count me as your first customer. I\'ll drop my bucks!',
  ...
  },
  {
    ...
    ko: '저는 투자도 많이 하고 있습니다. 토스증권 여러 항목에서 수익률 1위를 달성한 경험도 있습니다. 현재는 여러 알고리즘 트레이딩 전략을 공부 중입니다. 가끔은 정교한 계산으로 대박을 터뜨리기도 하고 가끔은 시장의 광기에 쪽박을 보기도 하지만, 매일 배움을 통해 전략을 탄탄히 다져나가고 있습니다. 물론 지금 백만장자는 아니어도 언젠가는 큰 목표를 달성하리라 생각합니다.',
  },
  {
    ...
    ko: '저는 콘솔 게임을 무척 좋아하고, 특히 스토리성이 풍부하거나 사운드트랙이 뛰어난 게임에 몰입합니다. 소설이 19세기의 문학, 영화가 20세기의 새로운 문학이었다면, 게임은 21세기의 새로운 문학이라 생각합니다. 좋은 게임을 감상하고 음미하는 것은 하나의 기술이자 특권이라 봅니다. 제가 특히 좋아하는 작품으로는 "고스트 오브 쓰시마", "데스 스트랜딩", "디트로이트: 비컴 휴먼", "스플래툰 3", "슈퍼마리오 오디세이" 그리고 "산나비"를 꼽을 수 있으며, "라스트 오브 어스"와 "스파이더맨" 시리즈 또한 훌륭한 작품으로 평가하고 있습니다. 또 최근에는 리듬세상에 푹 빠져서, 닌텐도 Wii와 DS, 그리고 게임보이 (아날로그 포켓)으로 리듬세상을 하는 재미에 살고 있습니다. 이렇게 보면 음악이 좋은 게임을 좋아하는 것 같기도 합니다.',
  },
  {
    en: "I am obsessed with a11y (Accessibility) and i18n (Internationalization). Two parts of me play with this. First, I felt left out for a while, not being in the loop with American Outlets. The notion of being on the scene is heavy, and I've seen so many talented friends missing out on so many opportunities due to their linguistic barriers. The linguistic barrier, especially in tech, is the new Apartheid, even though it is not intentional. The second part is that these two are the fast and quick way to gauge how craftsmanshipful, mindful, and meticulously built the product is. If they screwed up on a11y and i18n, the chances are, it's not a mind-blowing product.",
    ko: '저는 a11y(접근성)와 i18n(국제화)에 대한 집착에 가까운 관심을 가지고 있습니다. 제가 미국에서 생활할 때 현지 문화나 언론에 접근할 때 문턱을 느낀 경험이 있습니다. 주변의 뛰어난 한국인 친구들이 언어 장벽으로 기회를 놓치는 모습을 보며, 언어 장벽이 의도치 않게 새로운 형태의 차별이 될 수 있다는 생각을 하게 되었습니다. 접근성과 국제화를 잘 고려한 제품일수록 장인정신과 배려심, 그리고 꼼꼼함이 담겨 있다고 생각합니다. a11y나 i18n을 소홀히 한 제품은 대개 기대만큼 훌륭하지 못하다는 판단을 하고 있습니다.',
  },
  {
  ...
  },
  {
    ...
    ko: '결국 저는 과학과 기술의 메디치가 되고 싶습니다. 메디치는 변화하는 르네상스 시대에 맞춰 뛰어난 사람들을 후원해 예술 산업을 개부심했습니다. 뛰어난 사람들을 움직여 더 나은 미래를 빚어낼 수 있다는 메디치의 가치에 저는 큰 울림을 받았고, 뛰어난 사람들이 모아 미래를 빚어나가고 싶다고 결심했습니다. 제 공상들을 현실로 바꾸고, 그 길을 닦아나가며, 이를 통해 사람들이 새로운 모험을 더욱 마음껏 즐길 수 있는 생태계를 만들어나가고자 합니다.',
  },
]
