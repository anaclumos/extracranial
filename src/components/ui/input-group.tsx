...
function InputGroupAddon({
  ...
  return (
    // biome-ignore lint/a11y/noStaticElementInteractions: Intentional - addon clicks focus the input
    // biome-ignore lint/a11y/noNoninteractiveElementInteractions: Intentional - addon clicks focus the input
    <div
