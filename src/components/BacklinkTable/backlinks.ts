export const backlinks = {
  ...
  emoji: {
    Satori:
      '- Font and [[**Emoji**]] Subsets from Google Fonts and ...',
    'Stories Behind Satori':
      'The same applies to [[**Emoji**|emojis]].\n',
    'TossFace Playground':
      '... Redistribution of Korean and Futuristic [[**Emoji**|**Emoji**s]]. [유니코드 Private Use Area를 이용해 ...',
  },
  tailwind: {
    Satori: '- [[**Tailwind**]] [[CSS',
  },
  'web worker': {
    Satori:
      '... in modern browsers, Node.js, and [[**Web Worker**|**Web Worker**s]]. Building on top of the ...',
    WorkerDOM:
      '... on providing DOM access to [[**Web Worker**]] Threads.\n',
    Research:
      '...     | _[[**Web Worker**]]_ (not _Workers_.) |\n',
    Atomics:
      '- SharedArrayBuffer를 이용해 [[**Web Worker**]] 사이 메모리를 동기화하기 위해 사용됨.\n',
    'Stories Behind Satori':
      '... will also benefit by targeting [[**Web Worker**|**Web Worker**s]].\n',
    iiframe:
      '... containerizes an embedded web inside [[**Web Worker**|**Web Worker**s]].\n',
    '2022-07-25':
    ...
    '2022-08-03':
      '... specializes in containerizing iframes in [[**Web Worker**|**Web Worker**s]].\n',
    '2022-07-19':
  ...
  'atomic notes system': {
    'Andy Matuschak':
      '... a new vision of online [[**Atomic Notes System**|Zettelkasten]].\n',
  ...
  backlink: {
    'Andy Matuschak':
      '... concepts, such as Sliding Panes, [[**Backlink**|links to this note]], and [[Atomic Notes System',
  ...
  'andy matuschak': {
    'Andy Matuschak':
      '... the Atomic Notes System|Zettelkasten technique. [[**Andy Matuschak**]] advanced ideas in Ahrens’ book ...',
  ...
  pdf: {
    ...
    '2022-06-05':
      '- _Convert ACSM files to [[**PDF**]]/EPUBs with one command on Linux ...',
  },
  naver: {
    'Screenshot as an API':
  ...
  mobi: {
    'Screenshot as an API':
      '... page loads. Better alternatives: epub, [[**mobi**]] for texts. For generic use ...',
  },
  djvu: {
    'Screenshot as an API':
      '... texts. For generic use cases, [[**DjVu**]].\n',
  },
  'transactional globe': {
    '3D Globe on the Web':
      '- [[**Transactional Globe**]]\n',
  ...
  'social network': {
    Jumpsite:
      '... a collective term for a [[**social network**]] service mainly consisting of links ...',
  },
  'hacker news': {
  ...
  sharedarraybuffer: {
    ...
    '2022-08-03':
      '... happens synchronously using Atomics and [[**SharedArrayBuffer**]].\n',
    '2022-06-27':
  ...
  extracranial: {
    Research:
      '...  | _Verb_-ing Plural | _[[**Extracranial**]]_      ...',
    Memex: '- The same word as [[**Extracranial**]].\n',
  ...
  fps: {
    'Graphics Engine Process':
      '... to 16ms, which yields 60 [[**FPS**]].\n',
    '2022-10-10':
      "... AC's & DIT's - Cinematography.com](https://cinematography.com/index.php?/forums/topic/71346-why-23976-and-not-24-fps/&tab=comments#comment-455454). [[**FPS**]].\n",
  },
  'back buffer': {
    'Graphics Engine Process':
  ...
  'font features': {
    'Toss Product Sans':
      '... figured it did not support [[**Font Features**]].\n',
    CalliFontia:
  ...
  'building a second brain': {
    ...
    CODE: '... second-brain building procedure introduced in [[**Building a Second Brain**]].\n',
  ...
  atomics: {
    '2022-07-11':
      '2. [[**Atomics**]] API. Use `wait()` and `notify()` ...',
    '2022-08-03':
