export const backlinks = {
  Apple: {
    ...
    '서울 프로':
      '본 목적은 Pretendard와 비슷하게 [[**Apple**]]의 [[San Francisco',
    'Screenshot as an API':
      '… - You can copy objects from photos in the latest [[**Apple**]] iOS 16 update.\n',
    Firefox:
      "…it from spawning additional threads in the thread pools used by [[**Apple**]]'s libraries_\n",
    'San Francisco': '- Font by [[**Apple**]]\n',
    'Apple Silicon': '- Chips made by [[**Apple**]]\n',
    Google:
      '…one of the Big Five American information technology companies, alongside Amazon, [[**Apple**]], Meta, and Microsoft. [Google](https://en.wikipedia.org/wiki/Google)\n',
    CalliFontia:
    ...
    '2022-10-13':
      '…iPhone to be their next phone; 31% of teens own an [[**Apple**]] Watch: [Taking Stock With Teens® - Fall 2022](https://www.pipersandler.com/1col.aspx?id=6216)\n',
    '2022-06-21':
      'However, [[**Apple**]] Feedback Assistant is not a developer Q&A platform.\n',
    '2022-06-10':
      '  - [[**Apple**]] has [implemented pointer authentication](https://support.apple.com/guide/security/operating-system-integrity-sec8b776536b/1/web/1#sec0167b469d) on all of its custom ARM-based silicon…',
    '2022-06-20':
      'Note that this is not [[**Apple**]] Passkey. This is the Privacy Pass standard. [[**Apple**',
    '2022-07-18':
      '…iPad as a Tools for Thought feels good. Especially writing with [[**Apple**]] Pencil.\n',
  },
  ...
  'Super App': {
    'Super App and Democracy':
      "…says, “It's no coincidence at all that WeChat is the only “[[**Super App**|everything app]]” anyone can cite, and it comes from China, an authoritarian regime._\n",
    Toss: "- I'd say _the most innovative_ Financial [[**Super App**]] I've ever seen in Korea and U.S.\n",
  },
  Vercel: {
    Satori:
      '…and Web Worker|Web Workers. Building on top of the core engine, [[**Vercel**]] OG can be used inside Edge environments through [[WebAssembly',
    'Stories Behind Satori':
      'The [[**Vercel**]] team [[Dogfooding|dogfooded',
    '2022-08-28':
      '- I both used Cloudflare Pages and [[**Vercel**]] and concluded that [[**Vercel**',
    '2022-07-10':
  ...
  WebAssembly: {
    Satori:
      '…core engine, Vercel OG can be used inside Edge environments through [[**WebAssembly**]] to create social card images easily.\n',
    'How is WebAssembly cross-platform when Assembly is not':
      '- What is the relationship between [[**WebAssembly**]] and [[Assembly',
    'Deno Deploy':
      '- TypeScript|TypeScript, [[**WebAssembly**|Wasm]], ES Modules\n',
    'Stories Behind Satori':
      'Using a [[**WebAssembly**|WASM]]-based approach also unlocked the possibility of running it on edge. [Introducing…',
    '2022-06-14':
  ...
  HTML: {
    Satori:
      '…is needed. Using Vercel OG, you can define your images using [[**HTML**]] and [[CSS',
    Tailwind:
    ...
    'Stories Behind Satori':
      'Given that SVG and [[**HTML**]] + [[CSS',
    'Markdown Email Client':
      '- Then... it sends as a beautiful and clean [[**HTML**]] email!\n',
    '2022-06-12':
      '…rehydration is a technique in which client-side JavaScript|JavaScript converts a static [[**HTML**]] web page, delivered either through static hosting or server-side rendering, into…',
  },
  CSS: {
    ...
    'Stories Behind Satori':
      'After simplifying the syntax with JSX and simple [[**CSS**]], Shu used [RazrFalcon/resvg](https://github.com/RazrFalcon/resvg) and [yisibl/resvg-js](https://github.com/yisibl/resvg-js) to convert the [[SVG',
    'Markdown Email Client':
      '- Before sending, select one [[**CSS**]]\n',
  },
  'Open Graph Image as a Service': {
    Satori:
      '…this for a while. [anaclumos/cho-sh-og-image: **Open Graph Image as a Service**](https://github.com/anaclumos/cho-sh-og-image). [[**Open Graph Image as a Service**]]\n',
    '2022-07-10':
  ...
  Emoji: {
    ...
    'TossFace Playground':
      '- Celebrating Redistribution of Korean and Futuristic [[**Emoji**|**Emoji**s]]. [유니코드 Private Use Area를 이용해 한국적, 시대적 가치를 담은 이모지 재배포…',
  },
  Tailwind: {
    Satori: '- [[**Tailwind**]] [[CSS',
  },
  'Web Worker': {
    Satori:
      '…core engine, [Satori](https://github.com/vercel/satori), can be used in modern browsers, Node.js, and [[**Web Worker**|**Web Worker**s]]. Building on top of the core engine, [[Vercel',
    WorkerDOM:
      "Google's take on providing DOM access to [[**Web Worker**]] Threads.\n",
    Research:
      '…   | Singular Noun     | _[[**Web Worker**]]_ (not _Workers_.) |\n',
    Atomics:
      '- SharedArrayBuffer를 이용해 [[**Web Worker**]] 사이 메모리를 동기화하기 위해 사용됨.\n',
    'Stories Behind Satori':
      'Converting it into WebAssembly|WASM will also benefit by targeting [[**Web Worker**|**Web Worker**s]].\n',
    iiframe:
      '- Improved `iframe` that containerizes an embedded web inside [[**Web Worker**|**Web Worker**s]].\n',
    '2022-07-25':
    ...
    '2022-07-21':
      '  - Unfreeze the [[**Web Worker**]] thread with `Atomic.notify()`.\n',
    '2022-08-03':
      '…iiframe — improved iframe — that specializes in containerizing iframes in [[**Web Worker**|**Web Worker**s]].\n',
    '2022-07-19':
  ...
  Assembly: {
    'How is WebAssembly cross-platform when Assembly is not':
      '- What is the relationship between Web**Assembly** and [[**Assembly**]]?\n',
  ...
  assembly: {
    ...
    'Inspecting Assembly':
      '…         | prints [[**assembly**]] codes          …',
  },
  Toss: {
    Tossface:
      '- [[**Toss**]] once withdrew the emojis, but I submitted a request to put…',
  ...
  FIRE: {
    ...
    'Fiercely Overpriced':
      '…enough data out on how the real-world Software as a Service [[**FIRE**]] will work out.\n',
    'FIRE Engine':
  ...
  'Tools for Thought': {
    Extracranial:
      '…function while acting as a searchable Wikipedia. It usually tightly integrates [[**Tools for Thought**]] and Online platforms. For this system, I use [Docusaurus](https://docusaurus.io/) and [Obsidian](https://obsidian.md/).…',
    PKM: 'Check [[**Tools for Thought**]] for PKM tools in the market.\n',
    Research:
      '…Concept | Plural Noun       | _[[**Tools for Thought**]]_           |\n',
    ...
    '2022-07-07':
      'I see a repeated paradigm in the [[**Tools for Thought**]] [[Software as a Service',
  },
  Svelte: {
  ...
  TypeScript: {
    ...
    'Deno Deploy':
      '- [[**TypeScript**|**TypeScript**]], [[WebAssembly|Wasm',
    '2022-07-20':
      '- JavaScript|JavaScript → [[**TypeScript**|**TypeScript**]]\n',
    '2022-09-30':
      '### [[**TypeScript**]] Dynamic Types with String Interpolations\n',
    '2022-07-06':
      '- Bundle, transpile, install and run JavaScript|JavaScript & [[**TypeScript**|**TypeScript**]] projects — all in Bun. Bun is a new JavaScript|JavaScript runtime…',
  },
  Satori: {
    WebAssembly: '- [[**Satori**]]\n',
    '2022-10-11': '- [[**Satori**]]\n',
  ...
  Inter: {
    'Font Features':
      '- San Francisco, [[**Inter**]], and [[Pretendard',
  },
  Pretendard: {
    'Font Features':
  ...
  SVG: {
    ...
    'Stories Behind Satori':
      '…and simple CSS, Shu used [RazrFalcon/resvg](https://github.com/RazrFalcon/resvg) and [yisibl/resvg-js](https://github.com/yisibl/resvg-js) to convert the [[**SVG**]] image to [[PNG',
  },
  ...
  PDF: {
    'Screenshot as an API':
      "  - Enterprise-grade OCR for [[**PDF**]] documents still doesn't exist in 2022, albeit having state-of-the-art computer vision…",
    '2022-06-05':
      '- _Convert ACSM files to [[**PDF**]]/EPUBs with one command on Linux \\(and macOS very soon\\). This software…',
  },
  Naver: {
    'Screenshot as an API':
  ...
  IRS: {
    'Screenshot as an API':
      '- The "killer app" for PDF was tax returns - the [[**IRS**]] adopted PDF in 1996 because of a rumored frustration with the…',
  },
  epub: {
    'Screenshot as an API':
      '  - Slow page loads. Better alternatives: [[**epub**]], [[mobi',
  },
  mobi: {
    'Screenshot as an API':
  ...
  DjVu: {
    'Screenshot as an API':
      '…loads. Better alternatives: epub, mobi for texts. For generic use cases, [[**DjVu**]].\n',
  },
  'Transactional Globe': {
    '3D Globe on the Web':
      '- [[**Transactional Globe**]]\n',
  ...
  GDPR: {
    ...
    'Plausible Analytics':
      '…lightweight and open-source web analytics. No cookies and fully compliant with [[**GDPR**]], [[CCPA',
  },
  PECR: {
  ...
  CCPA: {
    ...
    'Plausible Analytics':
      '…and open-source web analytics. No cookies and fully compliant with GDPR, [[**CCPA**]], and [[PECR',
  },
  '2022-07-01': {
  ...
  PARA: {
    ...
    '2022-07-01':
      'I like the CODE Procedure in [[**PARA**]] architecture as a project management system, which does more than [[PKM',
    '2022-06-26': '- [[**PARA**]]\n',
    '2022-07-03':
  ...
  Markdown: {
    Inliner:
      'However, [[**Markdown**]] will automatically convert them into flowing text, making the reading experience…',
    'Markdown Email Client':
  ...
  Google: {
    WorkerDOM:
      "[[**Google**]]'s take on providing DOM access to [[Web Worker",
    'Stories Behind Satori':
      "They also added [[**Google**]] Font's `?text=` API, containing a specific subset of the [[CJK",
  ...
  SharedArrayBuffer: {
    ...
    Atomics:
      '- [[**SharedArrayBuffer**]]를 이용해 [[Web Worker',
  ...
  'Delta Time': {
    ...
    'Graphics Engine Process':
      '    - If [[**Delta Time**]] is bigger than Max [[**Delta Time**',
  },
  'Graphics Engine Process': {
    'Game Programming':
      '- [[**Graphics Engine Process**]]\n',
  ...
  Notion: {
    ...
    '2022-07-10':
      '- [[**Notion**]] opened a new paradigm for low-code websites. [[Project PEOPLE',
    '2022-07-07':
      'I think even [[**Notion**]] is too complicated for personal task managing.\n',
  },
  JavaScript: {
    'Tools for Thought':
      '- [Bear Blog](https://bearblog.dev/): No trackers, no [[**JavaScript**|javascript]], no stylesheets blog for hackers\n',
    'Deno Deploy':
    ...
    '2022-07-20':
      '- [[**JavaScript**|**JavaScript**]] → [[TypeScript|TypeScript',
    '2022-06-20':
      "…are increasingly API-driven. CAPTCHAs cannot work in an API environment where [[**JavaScript**|**JavaScript**]] can't be rendered or a WebView can't be called.\n",
    '2022-06-22':
      'Then, Brane should cover very partial [[**JavaScript**]] APIs.\n',
    '2022-07-18':
      '- No trackers, no [[**JavaScript**|javascript]], no stylesheets. Just your words\n',
    '2022-06-12':
      '…web development, hydration or rehydration is a technique in which client-side [[**JavaScript**|**JavaScript**]] converts a static [[HTML',
    '2022-07-12':
      '1. Demo [[**JavaScript**]] animation works as expected.\n',
    '2022-07-06':
      '- Bundle, transpile, install and run [[**JavaScript**|**JavaScript**]] & [[TypeScript|TypeScript',
  },
  NextJS: {
  ...
  FPS: {
    ...
    '2022-10-10':
      "…23.976 and not 24 fps?? - AC's & DIT's - Cinematography.com](https://cinematography.com/index.php?/forums/topic/71346-why-23976-and-not-24-fps/&tab=comments#comment-455454). [[**FPS**]].\n",
  },
  'Back Buffer': {
    'Graphics Engine Process':
  ...
  ShadowRealm: {
    'Realm Shim':
      '> Shim implementation of the [Realm API Proposal](https://github.com/tc39/proposal-realms/#ecmascript-spec-proposal-for-realms-api) ([[**ShadowRealm**]])\n',
    '2022-06-26':
      "- Let's not explore [[**ShadowRealm**]] and `iframe` [[Sandbox",
  },
  Grammarly: {
    'Handwriting Grammarly':
  ...
  'Building a Second Brain': {
    ...
    '2022-06-14':
      '- _[[**Building a Second Brain**]]: A Proven Method to Organize Your Digital Life and Unlock Your…',
  ...
  JSX: {
    'Stories Behind Satori':
      'After simplifying the syntax with [[**JSX**]] and simple [[CSS',
  },
  PNG: {
    'Stories Behind Satori':
      '…Shu used [RazrFalcon/resvg](https://github.com/RazrFalcon/resvg) and [yisibl/resvg-js](https://github.com/yisibl/resvg-js) to convert the SVG image to [[**PNG**]].\n',
  },
  Dogfooding: {
    'Stories Behind Satori':
  ...
  'FIRE Engine': {
    ...
    '2022-07-26':
      '…PencilKit](https://github.com/simonbs/InfiniteCanvas), it seems relatively easy to convert this into a full-blown [[**FIRE Engine**]].\n',
  },
  'Project PEOPLE': {
    'Separation of Computer Scientists and Computer Technologists':
    ...
    '2022-07-05':
      '- Some [[**Project PEOPLE**]] asked why it is _computer scientist_ instead of _software engineer_... And…',
    '2022-07-10':
  ...
  'Fiercely Overpriced': {
    ...
    '2022-07-18':
      '- [[**Fiercely Overpriced**]] for [[Open Graph Image as a Service',
  },
  ...
  Cloudflare: {
    ...
    '2022-08-28':
      '- **Key Strengths of Vercel over [[**Cloudflare**]] Pages**. Vercel builds faster (~3m) than [[**Cloudflare**',
    '2022-06-20':
  ...
  Python: {
    ...
    '0001 Two Sum':
      'I used [[**Python**]] Dictionary to store complementing values. [[**Python**',
    'Coding Tests':
      '- Will use [[**Python**]] (main language) and [[C++',
    Python:
  ...
  'Coding Tests': {
    ...
    '2022-06-06':
      '- _[[**Coding Tests**]] questions_ - [Grind 75 - A better Blind 75 you can…',
  ...
  WorkerDOM: {
    ...
    '2022-08-03':
      'I did reach a milestone in implementing synchronicity inside [[**WorkerDOM**]], but now I finally realize various advanced use cases exist in…',
    '2022-06-14':
      '- [[**WorkerDOM**]]과 JSDOM은 각자의 한계가 뚜렷하다.\n',
    '2022-06-27':
      "- Confirm [[**WorkerDOM**]]'s Binary DOM Manipulation channel.\n",
    '2022-07-19':
      '오늘은 반드시 [[**WorkerDOM**]] [[Scheduler',
    '2022-06-22':
      'Preferably, [[**WorkerDOM**]] and [[Web Worker',
    '2022-06-26':
      '- Investigate how [[**WorkerDOM**]] terminates an application. This is a Web Spec.\n',
    '2022-07-12':
      '### Scheduler|Schedulers in [[**WorkerDOM**]]\n',
    '2022-07-06':
      "…the Technical Proof of Concept and posted here: _PoC that two [[**WorkerDOM**]] upgraded threads don't block each other_ - [Two Roots](https://brane.vercel.app/two-roots-with-infinite-loop/)\n",
  },
  ...
  Scheduler: {
    ...
    '2022-07-19':
      '2022-07-11에 확인한 2가지 [[**Scheduler**|스케줄러]]를 확인한다.\n',
    '2022-07-12':
      '### [[**Scheduler**|**Scheduler**s]] in [[WorkerDOM',
  },
  'DOM Reflow': {
    '2022-07-11':
  ...
  Atomics: {
    '2022-07-11':
      'To automatically use [[**Atomics**]] API for every third-party app, [[Brane',
    '2022-08-03':
      'This happens synchronously using [[**Atomics**]] and [[SharedArrayBuffer',
    '2022-06-27':
      '- Learn more about [[**Atomics**]] and [[SharedArrayBuffer',
  ...
  iiframe: {
    '2022-08-03':
      'One straightforward use case [[**iiframe**]] — improved iframe — that specializes in containerizing iframes in [[Web…',
  },
  Academics: {
  ...
  '2022-07-11': {
    '2022-07-19':
      '[[**2022-07-11**]]에 확인한 2가지 [[Scheduler|스케줄러',
    '2022-07-12':
      'On [[**2022-07-11**]], I analyzed that [[Brane',
  },
  'Autosave Everything': {
  ...
  Firefox: {
    '2022-10-10':
      '…responsiveness on macOS - Mozilla Hacks - the Web developer blog](https://hacks.mozilla.org/2022/10/improving-firefox-responsiveness-on-macos/) [[**Firefox**]]\n',
  },
  '2971DF.jpeg': {
  ...
  Research: {
    '2022-10-11':
      '…on a Journal Page, I should start separating them into individual [[**Research**]] pages.\n',
  },
  '1F98FE.jpeg': {
