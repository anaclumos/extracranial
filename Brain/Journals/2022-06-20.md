...
- Usability aside, mobile environments present an additional challenge in that they are increasingly API-driven. CAPTCHAs simply cannot work in an API environment where [[JS|JavaScript]] can’t be rendered, or a WebView can’t be called.
