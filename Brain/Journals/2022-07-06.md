...
![Confirmed that two WorkerDOM threads and one main thread appear.](3B652B.png)

- One thing to confirm: `two-roots` uses `getBoundingClientRectAsync`

![The above redundancy is for different browser supports for `module`.)](54F5D2.png)
