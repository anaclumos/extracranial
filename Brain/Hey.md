...
I am also a massive fan of Computational Linguistics, so I want to try automating translations one day.
...
If you are familiar with such concepts, this place is also a [[Memex]] or a Digital Garden.
Unlike traditional blogs or notes, this is a non-linear space.
There are no predefined categories, tags, and sequential order. It retains minimal hierarchy.
Therefore you can randomly pick a note and follow the links to other writings.
Every note will be [[evergreen notes]], interrelating with additional notes, illustrating the connections between ideas, thus capturing the bigger picture.
