...
- PSR should be under 1.5x: This is linked to **Ken Fisher’s** _Super Stocks_ approach, which popularized P/S as a key filter (often seeking very low P/S, e.g., ≤0.75; some secondary summaries use **<1.5** as a practical cutoff).
- ROE should be above 15%
- PER under 15x, PBR under 1.5x: These are **Benjamin Graham** heuristics (the classic “Graham number” uses 15× earnings and 1.5× book).
