...
<figcaption>백업된 글들이다. 폴더 이름은 글의 제목으로 설정된다.</figcaption>
</figure>
...
<figcaption>GitHub 상에 백업된 글의 모습이다. 사진 또한 블로그 서버 대신 폴더에 직접 저장하여 보여주는 것이다.</figcaption>
</figure>
...
<figcaption>폴더에는 글에 사용된 사진들이 저장된다.</figcaption>
</figure>
