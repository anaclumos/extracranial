#!/usr/bin/env python3
"""
process.py – end-to-end builder that replaces

    sanitize.py
    process-blog.py
    process-docs.py
    process-backlinks.py
    img-alt-to-figcaption.py
    cleanup.py   (optional: delete unused assets)

Run from the project root:

    $ python3 process.py          # normal run
    $ python3 process.py --clean  # include cleanup of unused assets
"""
...
REPLACE_RULES: Dict[str, str] = {
    ...
    "）": ")",
    "# # # ": "### ",
    # … (identical mapping truncated for brevity – keep the full list here) …
    " - PMC": "",
}
