...
<figcaption>Minimal. The widget takes one side of the Dynamic Island when two or more background activities are ongoing.</figcaption>
</figure>
...
<figcaption>Compact: The standard form, where the widget takes both sides of the Dynamic Island when there is one ongoing background activity.</figcaption>
</figure>
...
<figcaption>Expanded: The biggest size of the the Dynamic Island, shown when the user long-presses on the Dynamic Island. It cannot display content in the red area.</figcaption>
</figure>
</DisplayFlex>
...
<figcaption>Different sizes of the Dynamic Island. Considering that there is a typo on the image, it doesn't seem like an official document.</figcaption>
</figure>
...
![As of Oct 16th, 2022](EA6CDB.gif)
...
<figcaption>I was a huuuuge fan of IZ*ONE back then... 😅</figcaption>
</figure>
...
![Spotify Now Playing API](15E359.png)
...
![Apple Music Get Recently Played Tracks](22AFE7.png)
...
<figcaption>Apple: Documentation? Nah.</figcaption>
</figure>
...
![MusicKit on the Web](7B29C5.png)
...
<figcaption>This website will do nothing else than calling the authorization process.</figcaption>
</figure>
...
<figcaption>It will show the Apple Music access grant page like this.</figcaption>
</figure>
...
<figcaption>It sounds straightforward, but it took me days to figure it out. 😭</figcaption>
</figure>
...
<figcaption>I don't know how long I struggled to find this typo.</figcaption>
</figure>
...
<figcaption>But something felt empty.</figcaption>
</figure>
...
![Lavender Haze by Taylor Swift](1F832D.gif)
...
![Hype Boy by NewJeans](6AA1FF.gif)
...
<figcaption>Much smoother.</figcaption>
</figure>
...
<figcaption>I saw a similar bug at the iOS 16 Notification Center. Maybe Apple is also clipping?</figcaption>
</figure>
...
<figcaption>Look closely. The border cuts into the squircle when the animation exits.</figcaption>
</figure>
