...
<figcaption>As you can see in the right three images, you can represent any image with border and shape with pure black and white. DemonDeLuxe (Dominique Toussaint), CC BY-SA 3.0, via Wikimedia Commons.</figcaption>
</figure>
...
<figcaption>Note: Braille Patterns from Wikipedia and Unicode Tables</figcaption>
</figure>
...
<figcaption>An example screenshot. I didn't use GPU acceleration, so it took about 19 minutes. I could've optimized this, but this function runs only once for any video, so I didn't bother.</figcaption>
</figure>
...
<figcaption>It turned out that SubRip's text stylings are non-standard. Source: en.wikipedia.org</figcaption>
</figure>
...
<figcaption>You would never imagine _compressing_ a _text_ file...</figcaption>
</figure>
...
<figcaption>Mobile devices show space instead of an empty circle. On the left, you can see almost no details, but on the right, you can see more gradients and details. The right one is the dithered version. Dithering especially shines when you have a black background or color gradients.</figcaption>
</figure>
...
<figcaption>The original image from the video. BTS Jimin</figcaption>
</figure>
...
<figcaption>The first image uses 16M colors, and the second and third use 256 colors. Dithered images use compressed color space, but you can feel the details and gradients. Image from en.wikipedia.org</figcaption>
</figure>
