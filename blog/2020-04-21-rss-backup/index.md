...
<figcaption>The backed-up posts. The folder names are set to the post titles.</figcaption>
</figure>
...
<figcaption>The appearance of a backed-up post on GitHub. The photos are also stored directly in the folder instead of the blog server.</figcaption>
</figure>
...
<figcaption>The photos used in the post are saved in the folder.</figcaption>
</figure>
