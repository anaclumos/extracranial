...
_Notion started the `.so` trend... But why did it stick?_
...
Needless to say, The success of Notion and its remora companies instated .so domain as the new .io domain, creating many blooming tech businesses.
...
Nowadays, .ai from Anguilla is the go-to for anything remotely close to artificial intelligence. You might have already guessed; it's now harder to keep AI out of the tech stack in 2024, so the odds are you're C-levels will want an .ai domain.

Arthur C. Clarke published a science fiction short story, "The Nine Billion Names of God." The story revolves around a Tibetan lamasery (a monastery) and its centuries-long quest to list all the names of God. The lamas believe that the Universe was created for this purpose and will end once all the names are written down. They have calculated that there are approximately nine billion such names (I won't spoil the rest of the story).

But names are finite. There are only a handful of "memorable" names. Yet, there are too many domain squatters, causing these hectic domain TLD migrations. The domain registration process is broken, but that's a story for another day.

🧑🏻‍⚕️🧑🏻‍🎓🧑🏻‍🏫🧑🏻‍⚖️🧑🏻‍🌾🧑🏻‍🍳🧑🏻‍🔧🧑🏻‍🔬🧑🏻‍💻🧑🏻‍🎤🧑🏻‍🎨🧑🏻‍✈️🧑🏻‍🚀🧑🏻‍🚒👮🏻🕵🏻💂🏻👷🏻

Each industry has its unique clothing style, with either practical or historical reasons.

TLD is like business attire. It serves as a landmark of your industry.
...
A new type of internet TLD culture is born from a broken domain registration infra. Limitations spawn creativity.
