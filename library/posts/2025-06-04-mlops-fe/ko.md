...
![서비스 다이어그램](./02AAEE.png '서비스 다이어그램')
...
<details>
<summary>부분 프리렌더링 (리액트 서버 컴포넌트의 최신 패러다임)</summary>
