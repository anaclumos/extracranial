...
date: 2020-04-21
description: 'RSS를 활용해 Ghost 블로그의 글과 이미지를 사람 읽기 쉬운 마크다운으로 백업하고, 이미지 다운로드·링크 보정까지 자동화해 복원 가능한 아카이브를 만든 과정.'
slug: '/21E029'
---
...
<Figure src="/generated/newsroom/21E029/E3B274.png" alt="백업된 글들이다. 폴더 이름은 글의 제목으로 설정된다." width={1624} height={1068} />

<Figure src="/generated/newsroom/21E029/E98816.png" alt="GitHub 상에 백업된 글의 모습이다. 사진 또한 블로그 서버 대신 폴더에 직접 저장하여 보여주는 것이다." width={2200} height={4000} />

<Figure src="/generated/newsroom/21E029/C55153.png" alt="폴더에는 글에 사용된 사진들이 저장된다." width={2200} height={800} />
