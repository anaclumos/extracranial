...
date: 2020-04-21
description: 'Back up a Ghost blog with RSS: Markdown, images, fixed links, and a Python script.'
slug: '/21E029'
---
...
<Figure src="/generated/newsroom/21E029/9B416C.png" alt="Jekyll Style Front Matter on GitHub" width={2609} height={344} />
...
<Figure src="/generated/newsroom/21E029/E3B274.png" alt="The backed-up posts. The folder names are set to the post titles." width={1624} height={1068} />

<Figure src="/generated/newsroom/21E029/E98816.png" alt="The appearance of a backed-up post on GitHub. The photos are also stored directly in the folder instead of the blog server." width={2200} height={4000} />

<Figure src="/generated/newsroom/21E029/C55153.png" alt="The photos used in the post are saved in the folder." width={2200} height={800} />
