...
title: '점자로 보는 뮤직 비디오'
date: 2021-07-05
description: '영상 프레임을 흑백 디더링·브라유 문자로 변환해 자막 스트림에 담아 터미널에서 ‘ASCII 아트’처럼 재생하는 방법과 구현.'
slug: '/AF848F'
---
...
<Figure src="/generated/newsroom/AF848F/9F37F9.png" alt="우측 3개의 이미지에서 볼 수 있듯이, 그 사이의 Gray 없이 #000000 검정과 #FFFFFF 하양만으로 경계선과 형체를 만들어낼 수 있다. DemonDeLuxe (Dominique Toussaint), CC BY-SA 3.0, via Wikimedia Commons." width={720} height={240} />
...
<Figure src="/generated/newsroom/AF848F/9F5DCD.png" alt="왼쪽 → 오른쪽" width={4096} height={2160} />
...
<Figure src="/generated/newsroom/AF848F/A3F3F9.png" alt="참고: Braille Patterns 위키백과, 유니코드 테이블." width={4096} height={2160} />
...
<Figure src="/generated/newsroom/AF848F/7B31B6.png" alt="위와 같은 모습으로 처리된다. GPU 가속을 사용하지 않기에 19분 15초로 상당히 오래 시간이 소요된다." width={3584} height={2240} />
...
<Figure src="/generated/newsroom/AF848F/825897.png" alt="SubRip 파일의 Text Styling에 분명 Yes라고 나와있었는데 이는 비공식적인 스타일링 문법이었다. 출처: en.wikipedia.org" width={2210} height={1260} />
...
<Figure src="/generated/newsroom/AF848F/6E854E.png" alt="텍스트 파일이 70MB!" width={1374} height={880} />
...
<Figure src="/generated/newsroom/AF848F/B41D3A.png" alt="모바일 기기에서 점자가 비어있는 칸은 완전한 공백으로 나타난다. 왼쪽에서는 거의 아무런 디테일이 보이지 않지만, 디더링 처리가 된 우측에서 훨씬 많은 디테일이 보인다. 이는 특히 검은 배경이 많거나 Color Gradation이 많은 화면에서 디더링의 효과가 두드러진다." width={2000} height={542} />

<Figure src="/generated/newsroom/AF848F/15976A.png" alt="뮤직 비디오의 원본 장면이다. BTS 지민." width={2560} height={1090} />
...
<Figure src="/generated/newsroom/AF848F/576E13.png" alt="1번 사진은 16백만 색상을, 2번과 3번 사진은 256색상을 사용한다. 디더링 처리된 이미지는 압축된 색 영역을 사용하지만 디테일이 느껴진다. 이미지 출처: en.wikipedia.org" width={3079} height={954} />
