...
date: 2021-07-05
slug: '/AF848F'
description: 'Turn videos into Unicode braille subtitle streams to “play” as ASCII art: dithering, frame processing, subtitle formats, and tools.'
---
...
<Figure src="/generated/newsroom/AF848F/9F37F9.png" alt="As you can see in the right three images, you can represent any image with border and shape with pure black and white. DemonDeLuxe (Dominique Toussaint), CC BY-SA 3.0, via Wikimedia Commons." width={720} height={240} />
...
<Figure src="/generated/newsroom/AF848F/9F5DCD.png" alt="Left → Right" width={4096} height={2160} />
...
<Figure src="/generated/newsroom/AF848F/58DD72.png" alt="Note: Braille Patterns from Wikipedia and Unicode Tables" width={4096} height={2160} />
...
<Figure src="/generated/newsroom/AF848F/7B31B6.png" alt="An example screenshot. I didn't use GPU acceleration, so it took about 19 minutes. I could've optimized this, but this function runs only once for any video, so I didn't bother." width={3584} height={2240} />
...
<Figure src="/generated/newsroom/AF848F/825897.png" alt="It turned out that SubRip's text stylings are non-standard. Source: en.wikipedia.org" width={2210} height={1260} />
...
<Figure src="/generated/newsroom/AF848F/D676F4.png" alt="No style info (markup) is recognized in SubRip." width={3074} height={1599} />
<Figure src="/generated/newsroom/AF848F/84D026.png" alt="Simple markups are supported in SAMI." width={2235} height={1648} />
...
<Figure src="/generated/newsroom/AF848F/6E854E.png" alt="You would never imagine _compressing_ a _text_ file..." width={1374} height={880} />
...
<Figure src="/generated/newsroom/AF848F/B41D3A.png" alt="Mobile devices show space instead of an empty circle. On the left, you can see almost no details, but on the right, you can see more gradients and details. The right one is the dithered version. Dithering especially shines when you have a black background or color gradients." width={2000} height={542} />

<Figure src="/generated/newsroom/AF848F/15976A.png" alt="The original image from the video. BTS Jimin" width={2560} height={1090} />
...
<Figure src="/generated/newsroom/AF848F/576E13.png" alt="The first image uses 16M colors, and the second and third use 256 colors. Dithered images use compressed color space, but you can feel the details and gradients. Image from en.wikipedia.org" width={3079} height={954} />
