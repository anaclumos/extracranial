...
title: '웹 표준 미니앱의 어려움'
date: 2022-09-14
description: '당근 미니앱 연구 인턴 경험을 바탕으로 본 웹 표준 미니앱의 문제들: 생태계 제약, 개발자 경험 단절, 표준의 빈틈.'
slug: '/A370F3'
---
...
<Callout type="note" title="여기까지 정리" icon="💡">
...
<Figure src="/generated/newsroom/A370F3/F2E628.png" alt="스타벅스 웹앱" width={1284} height={2778} />
<Figure src="/generated/newsroom/A370F3/436C60.png" alt="스타벅스 미니앱" width={1284} height={2778} />
<Figure src="/generated/newsroom/A370F3/83C3AF.png" alt="스타벅스 앱" width={1284} height={2778} />
...
<Figure src="/generated/newsroom/A370F3/338106.png" alt="오히려 알 수 없는 URL이 나타나서 거부감을 일으킬 수 있다." width={1284} height={2778} />
...
> 컴퓨터 프로그래밍에서 심(shim)은 API 호출을 투명하게 가로채고 전달된 인수를 변경하거나, 작업 자체를 처리하거나, 다른 곳으로 작업을 리디렉션하는 라이브러리입니다. (In computer programming, a shim is a library that transparently intercepts API calls and changes the arguments passed, handles the operation itself, or redirects the operation elsewhere.) -- [Shim (computing)](<./%3Chttps://en.wikipedia.org/wiki/Shim_(computing)%3E>)

고양이가 위치 권한을 달라고 요구하는 데모 웹사이트를 만들어보았다.

<Horizontal>

<Figure src="/generated/newsroom/A370F3/19E9E9.png" alt="기본 동작" width={1284} height={2778} />
<Figure src="/generated/newsroom/A370F3/E8303F.png" alt="강제로 변경한 동작" width={1284} height={2778} />
...
<Figure src="/generated/newsroom/A370F3/37A817.gif" alt="얼어붙은 미니앱을 강제종료하는 슈퍼앱" width={480} height={200} />
...
<Callout type="info" title="JavaScript은 Single-Threaded하지 않나?" icon="🤔">
...
<Figure src="/generated/newsroom/A370F3/9B6073.png" alt="미션 임파서블 4에서 이단 헌트는 테러리스트 두 팀 사이에서 서로 상대방인 척 연기하며 적절하게 유리한 방향으로 교섭을 진행한다." width={1080} height={900} />
...
<Figure src="/generated/newsroom/A370F3/1561C2.png" alt="출처: web.dev/web-bundles" width={1600} height={932} />
...
<Figure src="/generated/newsroom/A370F3/D6AC53.png" alt="이렇게 수많은 기업들이 사용할 정도로 믿음직스러워 보이는 라이브러리도 방심하면 악성 코드가 된다." width={1400} height={1883} />

결과적으로 어떤 형태로든 슈퍼앱의 입장에서는
미니앱 제작사의 패키지를 직접 받아서
검수를 하고 다른 코드로 바꿔치지 못하도록 스스로 호스팅해야 한다.

<Figure src="/generated/newsroom/A370F3/D2C5B9.png" alt="근데 이건 이미 개발이 거의 완료되어 별도로 붙일만한 말이 없다." width={3108} height={2150} />
