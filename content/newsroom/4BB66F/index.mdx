...
date: 2020-05-11
description: 'How I built a Chrome/Firefox extension that filters YouTube comments by language, from initial idea to SPA quirks, permissions, and performance fixes.'
slug: '/4BB66F'
---
...
<Figure src="/generated/newsroom/4BB66F/7C928F.png" alt="YouTube, a strange video platform where a Korean singer sings a Korean song on a Korean broadcast, but there are only Korean comments" width={1440} height={900} />
...
<Figure src="/generated/newsroom/4BB66F/EF5C78.png" alt="We have a spy in our midst..." width={2000} height={2000} />
...
When I checked, the `<can-show-more>` tag appeared and disappeared under the comment whenever the loading icon appeared, so I thought I could catch the moment when YouTube's [**obfuscated**](<./%3Chttps://en.wikipedia.org/wiki/Obfuscation_(software)%3E>) javascript code inserted the `<can-show-more>` tag and re-run the filter accordingly.

<Figure src="/generated/newsroom/4BB66F/1A6BB3.png" alt="But I think I had that idea because I forgot what obfuscation means... After a few hours of struggle, I gave up" width={2000} height={1500} />
...
<Figure src="/generated/newsroom/4BB66F/E05A88.png" alt="User review of the alpha version. &quot;Slow performance, but it works&quot; is an accurate description of the alpha version" width={1500} height={1000} />
...
<Figure src="/generated/newsroom/4BB66F/B2ADCF.png" alt="Screenshot from the alpha version. The alpha version had a button to switch between Korean and full comments" width={2880} height={1800} />
...
<Figure src="/generated/newsroom/4BB66F/B1983C.png" alt="Lazy Loading on YouTube" width={2000} height={2000} />
...
<Figure src="/generated/newsroom/4BB66F/19BC81.png" alt="Bypassing YouTube's Lazy Loading" width={2000} height={2000} />
...
<Figure src="/generated/newsroom/4BB66F/F6B289.png" alt="Apparently the Chrome extension only checks the domain when a new page is loaded" width={2000} height={2000} />
...
<Figure src="/generated/newsroom/4BB66F/48749C.png" alt="YouTube is a SPA" width={2000} height={2000} />
...
<Figure src="/generated/newsroom/4BB66F/397577.png" alt="You might think this is a pointless task, but it works wonders for attracting more users than expected" width={2880} height={1800} />
...
<Figure src="/generated/newsroom/4BB66F/E15E32.png" alt="Review from a friend who has been using it since the beta version" width={1200} height={400} />
