...
date: 2021-02-16
slug: '/7BF6C2'
description: 'I built a weekend choice‑based meme recommendation app with Next.js: scenario tree design, static generation, and UX notes.'
---
...
<Figure src="/generated/newsroom/7BF6C2/E08CF2.png" alt="Here, a meme means a short video that makes you laugh." width={1280} height={324} />
...
<Figure src="/generated/newsroom/7BF6C2/949544.jpeg" alt="I could easily find the videos I thought were funny by searching for the keyword `youtu` in a group chat room." width={2000} height={2000} />
...
<Figure src="/generated/newsroom/7BF6C2/FC67D9.png" alt="In the process, I wanted to give the feeling that I want to join this club!!!" width={3840} height={2160} />
...
<Figure src="/generated/newsroom/7BF6C2/BE3DA7.png" alt="ALT: Fallback Video" width={3840} height={2160} />
