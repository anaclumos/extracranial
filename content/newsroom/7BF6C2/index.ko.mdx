...
date: 2021-02-16
slug: '/7BF6C2'
description: '주말에 Next.js로 선택형 밈 추천 앱을 만들었다: 시나리오 트리, 정적 생성, UX 디테일.'
---

최근 경쟁률이 매우 높은 (합격률 5% 내외) 교내 기술창업 동아리를 지원하는데 다음과 같은 질문이 있었습니다.

<Figure src="/generated/newsroom/7BF6C2/E08CF2.png" alt="여기서 meme이란 '웃음을 유발하는 짧은 동영상'과 같은 뜻입니다." width={1280} height={324} />
...
<Figure src="/generated/newsroom/7BF6C2/949544.jpeg" alt="단톡방에서 youtu 키워드로 검색해서 제가 웃기다고 생각한 동영상들을 쉽게 찾을 수 있었습니다." width={2000} height={2000} />
...
<Figure src="/generated/newsroom/7BF6C2/FC67D9.png" alt="그 과정에서 나는 이 동아리에 꼭 들어가고 싶다!!!라는 느낌을 뿜뿜하게 주고 싶었습니다." width={3840} height={2160} />
