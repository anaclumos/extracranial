...
date: 2020-10-30
slug: '/589DF4'
description: 'I use The Noun Project API with Python to batch‑download icons: OAuth setup, a reusable downloader, and pitfalls.'
---
...
<Figure src="/generated/newsroom/589DF4/63EB17.png" alt="I have run some benchmarks and found that downloading ~5k icons shouldn't be a problem." width={1588} height={1336} />
