...
title: 'API로 크롤링'
date: 2020-10-30
description: 'Python과 The Noun Project API로 아이콘을 대량 다운로드하는 법: OAuth 설정, 재사용 가능한 다운로드 함수, 사용 시 주의사항.'
slug: '/589DF4'
---
...
<Figure src="/generated/newsroom/589DF4/63EB17.png" alt="테스트를 해보았을 때 아이콘 5,000개 정도까지는 가뿐하게 다운로드할 수 있었다." width={1588} height={1336} />
