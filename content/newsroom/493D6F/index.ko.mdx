...
import AbsolutePathPlayer from '@/components/video/AbsolutePathPlayer'
...
<Figure src="/generated/newsroom/493D6F/02AAEE.png" alt="서비스 다이어그램" caption="서비스 다이어그램" width={2597} height={1888} />
...
<Accordion title="부분 프리렌더링 (리액트 서버 컴포넌트의 최신 패러다임)">
...
<Video src={videoF70351} loop muted autoPlay as={AbsolutePathPlayer} />
...
<Figure src="/generated/newsroom/493D6F/6FDB19.png" alt="맥 파인더 밀러 컬럼" width={2834} height={1908} />
...
<Figure src="/generated/newsroom/493D6F/C868F8.jpg" alt="구상했던 URL, 그리고 데스크톱, 모바일 뷰" width={3129} height={1591} />
...
<Video src={video5F8BA9} loop muted as={AbsolutePathPlayer} />
...
<Figure src="/generated/newsroom/493D6F/4040C0.png" alt="메트릭 그래프 뷰" width={1206} height={2622} />

<Figure src="/generated/newsroom/493D6F/B21ABE.png" alt="잡 리스트 뷰" width={1206} height={2622} />

<Figure src="/generated/newsroom/493D6F/493D6E.png" alt="프로젝트 테이블 뷰" width={1206} height={2622} />
...
<Figure src="/generated/newsroom/493D6F/3E96D2.png" alt="드래그 앤 드랍 다이얼로그" width={4112} height={2396} />
...
<Figure src="/generated/newsroom/493D6F/08A8B8.png" alt="입사 초기에 보낸 슬랙 메시지" width={2048} height={1024} />
