...
date: 2023-01-25
description: '아이폰에 삼성식 한국어 키보드(천지인) 경험을 옮긴 프로젝트: 설계 목표, UX 절충, 구현 요약.'
slug: '/D7DE14'
---



<Figure src="/generated/newsroom/D7DE14/7B584A.png" alt="ALT: 아이폰 키보드 &quot;하늘땅사람&quot;의 모습" width={3840} height={2160} />

<Callout type="info" title="잔말 말고 설치 링크부터 줘요" icon="💎">
...
<Figure src="/generated/newsroom/D7DE14/2DCA95.png" alt="자리넘김 버튼과 띄어쓰기 버튼이 따로 존재하는 아이폰 10키 키보드" width={3840} height={2160} />

<Callout type="info" title='예를 들어 "오 안녕"을 입력하기 위해서는...' icon="💎">
...
이 프로젝트의 [연구 기록](/research/C222D1)도 공개되어 있다.
...
<Figure src="/generated/newsroom/D7DE14/85D135.png" alt="ALT: `ㅇ` 근처 배경에 회색 배경이 있는 키보드 입력 모습" width={1179} height={2556} />

</Figure>

<Figure>

<Figure src="/generated/newsroom/D7DE14/B9DE45.png" alt="ALT: `ㅇ` 근처 배경에 회색 배경이 있는 키보드 입력 모습" width={750} height={1334} />

</Figure>

<Figure>

<Figure src="/generated/newsroom/D7DE14/A02D58.png" alt="ALT: `ㅇ` 근처 배경에 회색 배경이 있는 키보드 입력 모습" width={1179} height={2556} />
...
<Callout type="info" title='케이스가 너무 많고 복잡하면' icon="💎">
...
<Callout type="tip" title="직접 해보자!" icon="🧪">
...
<Callout type="info" title="활자는" icon="💎">
  가장 <strong>단순한</strong> 구현체이지 가장 <strong>가벼운</strong> 구현체는 아니라는 점을 명심하자.
</Callout>


<Accordions>
<Accordion title="조합형 한글로 문자열 정규화를 하면 좀 더 경우의 수가 줄지 않나요?">
...
<Figure src="/generated/newsroom/D7DE14/8E6907.jpeg" alt="2023년에도 행복하세요 💙" width={1179} height={1235} />
...
<Figure src="/generated/newsroom/D7DE14/68C6BB.png" alt="볼드체 텍스트가 비활성화된 경우" width={1179} height={2556} />

<Figure src="/generated/newsroom/D7DE14/F93D1B.png" alt="볼드체 텍스트를 활성화한 경우" width={1179} height={2556} />
...
<Figure src="/generated/newsroom/D7DE14/ADBBB1.gif" alt="우측 하단의 키보드 종료 버튼을 탭하면 키보드가 사라진다." width={480} height={1040} />

## 🧑🏻‍🎨 Midjourney를 이용한 앱 아이콘 생성

<Figure>

<Figure src="/generated/newsroom/D7DE14/69A76A.png" alt="ALT: Midjourney 이미지들" width={1532} height={1862} />
...
<Figure src="/generated/newsroom/D7DE14/C387F9.png" alt="이와 같이 앱스토어 콘솔에서 GitHub와 연동된 빌드를 확인할 수 있다." width={3584} height={2240} />

</Figure>

<Figure>

<Figure src="/generated/newsroom/D7DE14/E0B0FF.png" alt="이렇게 푸시 알림도 보내준다." width={1179} height={2556} />
...
<Callout type="info" title="앱스토어 5점 리뷰와 GitHub 스타는 큰 응원이 됩니다!" icon="💙">
