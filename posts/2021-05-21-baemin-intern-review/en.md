...
![ALT: Internship at Woowa Bros 🚚](976A54.jpg)
...
![ALT: No shoes allowed - aka **Sushi Bar Lounge**. First come, first served with a great view](77D98C.jpeg)
...
![The interview room of Woowa Brothers. Initially, the interview should have been held here, but due to the spread of COVID-19, it was conducted through Google Meet](98526C.jpeg)
...
![During the 4th project, we were forced to work remotely due to social distancing tier 2](F49613.png)
...
![JS I don't know anything, I'm just a talking potato, okay?](6B271D.jpg)
...
### 🌎 What is knowledge in the internet age?
...
![Search... but every time?](12A854.png)
...
![A developer using npm i?](2B2DBB.gif)
...
> Libraries are not Protoss 👽 tech; they are Terran 🧑‍🔧 tech.
...
### 🧩 Crawling the Woowa image server
...
![Image swiped from Woowa B-mart image server](D7B4B2.png)
...
![Naver Connect Boostcamp Server got busted](C7EE19.png)
...
I was so inspired that I tried to improve the design from the 3rd BankSalad project. I thoroughly revised the plan like this. ↓

![Sample bankbook design mockup. This is just a starting point, and it's up to the campers to get creative with it](31E2FF.png)

![I realized that designing is more fun than I thought (I'm satisfied)](E524D3.png)
...
- Of course, I won't be perfect right away. I've been feeling the gap between my ideals and reality lately. Still, if we set our compass to our ideal destination, we will reach it one day 🧭.
