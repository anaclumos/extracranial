...
var renderTemplate = (tmpl, data) => {
  ...
  text = text.replace(/{{imageNameKey}}/gm, data.imageNameKey).replace(/{{fileName}}/gm, data.fileName).replace(/{{uuid}}/gm, getRandomUuid(true, "-")).replace(/{{hex8}}/gm, getRandomHex(8, true)).replace(/{{hex4}}/gm, getRandomHex(4, true)).replace(/{{hex12}}/gm, getRandomHex(12, true)).replace(/{{hex}}/gm, getRandomHex(6, true));
  return text;
};
