...
───────────────────────────────────────────────────────────────────────────────
Markdown                   949     27919     6763         0    21156          0
CSS                         63     19653      155        30    19468          0
TypeScript                  50      8476      145        48     8283        134
...
───────────────────────────────────────────────────────────────────────────────
Total                     1125     60222     7210      1228    51784        231
───────────────────────────────────────────────────────────────────────────────
Estimated Cost to Develop (organic) $1,704,122
Estimated Schedule Effort (organic) 16.84 months
Estimated People Required (organic) 8.99
───────────────────────────────────────────────────────────────────────────────
Processed 2586307 bytes, 2.586 megabytes (SI)
───────────────────────────────────────────────────────────────────────────────
