...
Sun Jan 4 08:54:26 PM KST 2026
...
───────────────────────────────────────────────────────────────────────────────
Markdown            3,068      78,834    21,309         0     57,525          0
TypeScript             46       3,019       342        38      2,639        185
JSON                   40      23,196         0         0     23,196          0
CSS                    25       2,781       420       101      2,260          0
SVG                     9           9         0         0          9          0
YAML                    6          35         0         0         35          0
TypeScript Typ…         2          56         6         5         45          0
INI                     1           1         0         0          1          0
JSONC                   1          28         0         0         28          0
JavaScript              1       1,130         5         5      1,120         28
Plain Text              1           3         0         0          3          0
───────────────────────────────────────────────────────────────────────────────
Total               3,200     109,092    22,082       149     86,861        213
───────────────────────────────────────────────────────────────────────────────
Estimated Cost to Develop (organic) $2,933,333
Estimated Schedule Effort (organic) 20.70 months
Estimated People Required (organic) 12.59
───────────────────────────────────────────────────────────────────────────────
Processed 5517927 bytes, 5.518 megabytes (SI)
───────────────────────────────────────────────────────────────────────────────
```
