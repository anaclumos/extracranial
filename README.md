...
───────────────────────────────────────────────────────────────────────────────
Markdown                  1015     28852     7109         0    21743          0
CSS                         63     19524      155        30    19339          0
TypeScript                  50      8378      145        43     8190        142
...
───────────────────────────────────────────────────────────────────────────────
Total                     1191     60965     7556      1223    52186        239
───────────────────────────────────────────────────────────────────────────────
Estimated Cost to Develop (organic) $1,718,015
Estimated Schedule Effort (organic) 16.89 months
Estimated People Required (organic) 9.03
───────────────────────────────────────────────────────────────────────────────
Processed 2719780 bytes, 2.720 megabytes (SI)
───────────────────────────────────────────────────────────────────────────────
