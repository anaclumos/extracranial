...
───────────────────────────────────────────────────────────────────────────────
Markdown                  1829     46383    12005         0    34378          0
CSS                         70     20324      799        45    19480          0
TypeScript                  60     15449      193        69    15187        215
...
───────────────────────────────────────────────────────────────────────────────
Total                     2007    102446    15032       223    87191        298
───────────────────────────────────────────────────────────────────────────────
Estimated Cost to Develop (organic) $2,945,035
Estimated Schedule Effort (organic) 20.73 months
Estimated People Required (organic) 12.62
───────────────────────────────────────────────────────────────────────────────
Processed 4696211 bytes, 4.696 megabytes (SI)
───────────────────────────────────────────────────────────────────────────────
