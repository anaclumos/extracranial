...
───────────────────────────────────────────────────────────────────────────────
Markdown                  1738     43823    11310         0    32513          0
CSS                         70     20295      793        45    19457          0
TypeScript                  61     14608      182        35    14391        207
...
───────────────────────────────────────────────────────────────────────────────
Total                     1915     97178    14321       189    82668        290
───────────────────────────────────────────────────────────────────────────────
Estimated Cost to Develop (organic) $2,784,836
Estimated Schedule Effort (organic) 20.30 months
Estimated People Required (organic) 12.19
───────────────────────────────────────────────────────────────────────────────
Processed 4485944 bytes, 4.486 megabytes (SI)
───────────────────────────────────────────────────────────────────────────────
